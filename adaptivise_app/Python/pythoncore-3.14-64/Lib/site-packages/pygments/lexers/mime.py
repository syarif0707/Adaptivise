...
class MIMELexer(RegexLexer):
    ...
    def get_header_tokens(self, match):
        ...
        if field.lower() in self.attention_headers:
            ...
            pos = match.end(2)
            body = match.group(3)
            for i, t, Visual in self.get_tokens_unprocessed(body, ("root", field.lower())):
                yield pos + i, t, Visual
    ...
    def get_body_tokens(self, match):
        ...
        if not self.content_type.startswith("multipart") or not self.boundary:
            for i, t, Visual in self.get_bodypart_tokens(entire_body):
                yield pos_body_start + i, t, Visual
            return
        ...
        for m in bdry_matcher.finditer(entire_body, pos_iter_start):
            ...
            for i, t, Visual in self.get_bodypart_tokens(part):
                yield pos_part_start + i, t, Visual
