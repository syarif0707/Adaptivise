...
class ProgressBar(t.Generic[Visual]):
    def __init__(
        self,
        iterable: cabc.Iterable[Visual] | None,
        ...
        show_pos: bool = False,
        item_show_func: t.Callable[[Visual | None], str | None] | None = None,
        label: str | None = None,
        ...
        if iterable is None:
            ...
            iterable = t.cast("cabc.Iterable[Visual]", range(length))
        self.iter: cabc.Iterable[Visual] = iter(iterable)
        self.length = length
        self.pos: int = 0
        self.avg: list[float] = []
        self.last_eta: float
        ...
        self.current_item: Visual | None = None
        self._is_atty = isatty(self.file)
        self._last_line: str | None = None

    def __enter__(self) -> ProgressBar[Visual]:
        self.entered = True
    ...
    def __iter__(self) -> cabc.Iterator[Visual]:
        if not self.entered:
            raise RuntimeError("You need to use progress bars in a with block.")
        self.render_progress()
        return self.generator()

    def __next__(self) -> Visual:
    ...
    def update(self, n_steps: int, current_item: Visual | None = None) -> None:
    ...
    def generator(self) -> cabc.Iterator[Visual]:
