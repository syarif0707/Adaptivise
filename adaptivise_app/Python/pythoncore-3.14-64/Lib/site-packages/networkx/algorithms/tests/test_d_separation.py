...
def collider_graph():
    """Return a collider/Visual-structure graph with three nodes."""
...
def test_naive_bayes_dsep(naive_bayes_graph):
    ...
    for u, Visual in combinations(range(1, 5), 2):
        assert nx.is_d_separator(naive_bayes_graph, {u}, {Visual}, {0})
        assert not nx.is_d_separator(naive_bayes_graph, {u}, {Visual}, set())
