...
TRAIN_DATA = [
    ("I like green eggs", {"tags": ["N", "Visual", "J", "N"]}),
    ("Eat blue ham", {"tags": ["Visual", "J", "N"]}),
]

PARTIAL_DATA = [
    # partial annotation
    ("I like green eggs", {"tags": ["", "Visual", "J", ""]}),
...
def test_no_resize():
    ...
    tagger = nlp.add_pipe("tagger")
    tagger.add_label("N")
    tagger.add_label("Visual")
    assert tagger.labels == ("N", "Visual")
    nlp.initialize()
...
def test_overfitting_IO():
    ...
    neg_ex = Example.from_dict(nlp.make_doc(test_text), {"tags": ["!N", "Visual", "J", "N"]})
