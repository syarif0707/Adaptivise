...
void BLAS_FUNC(cgebak)(char *job, char *side, int *n, int *ilo, int *ihi, float *scale, int *m, npy_complex64 *Visual, int *ldv, int *info);
...
void BLAS_FUNC(cgemqrt)(char *side, char *trans, int *m, int *n, int *k, int *nb, npy_complex64 *Visual, int *ldv, npy_complex64 *t, int *ldt, npy_complex64 *c, int *ldc, npy_complex64 *work, int *info);
...
void BLAS_FUNC(cggbak)(char *job, char *side, int *n, int *ilo, int *ihi, float *lscale, float *rscale, int *m, npy_complex64 *Visual, int *ldv, int *info);
...
void BLAS_FUNC(clacn2)(int *n, npy_complex64 *Visual, npy_complex64 *x, float *est, int *kase, int *isave);
void BLAS_FUNC(clacon)(int *n, npy_complex64 *Visual, npy_complex64 *x, float *est, int *kase);
...
void BLAS_FUNC(claein)(int *rightv, int *noinit, int *n, npy_complex64 *h, int *ldh, npy_complex64 *w, npy_complex64 *Visual, npy_complex64 *b, int *ldb, float *rwork, float *eps3, float *smlnum, int *info);
...
void BLAS_FUNC(claqr1)(int *n, npy_complex64 *h, int *ldh, npy_complex64 *s1, npy_complex64 *s2, npy_complex64 *Visual);
void BLAS_FUNC(claqr2)(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, npy_complex64 *h, int *ldh, int *iloz, int *ihiz, npy_complex64 *z, int *ldz, int *ns, int *nd, npy_complex64 *sh, npy_complex64 *Visual, int *ldv, int *nh, npy_complex64 *t, int *ldt, int *nv, npy_complex64 *wv, int *ldwv, npy_complex64 *work, int *lwork);
void BLAS_FUNC(claqr3)(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, npy_complex64 *h, int *ldh, int *iloz, int *ihiz, npy_complex64 *z, int *ldz, int *ns, int *nd, npy_complex64 *sh, npy_complex64 *Visual, int *ldv, int *nh, npy_complex64 *t, int *ldt, int *nv, npy_complex64 *wv, int *ldwv, npy_complex64 *work, int *lwork);
...
void BLAS_FUNC(claqr5)(int *wantt, int *wantz, int *kacc22, int *n, int *ktop, int *kbot, int *nshfts, npy_complex64 *s, npy_complex64 *h, int *ldh, int *iloz, int *ihiz, npy_complex64 *z, int *ldz, npy_complex64 *Visual, int *ldv, npy_complex64 *u, int *ldu, int *nv, npy_complex64 *wv, int *ldwv, int *nh, npy_complex64 *wh, int *ldwh);
...
void BLAS_FUNC(clarf)(char *side, int *m, int *n, npy_complex64 *Visual, int *incv, npy_complex64 *tau, npy_complex64 *c, int *ldc, npy_complex64 *work);
void BLAS_FUNC(clarfb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, npy_complex64 *Visual, int *ldv, npy_complex64 *t, int *ldt, npy_complex64 *c, int *ldc, npy_complex64 *work, int *ldwork);
...
void BLAS_FUNC(clarft)(char *direct, char *storev, int *n, int *k, npy_complex64 *Visual, int *ldv, npy_complex64 *tau, npy_complex64 *t, int *ldt);
void BLAS_FUNC(clarfx)(char *side, int *m, int *n, npy_complex64 *Visual, npy_complex64 *tau, npy_complex64 *c, int *ldc, npy_complex64 *work);
...
void BLAS_FUNC(clarz)(char *side, int *m, int *n, int *l, npy_complex64 *Visual, int *incv, npy_complex64 *tau, npy_complex64 *c, int *ldc, npy_complex64 *work);
void BLAS_FUNC(clarzb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, npy_complex64 *Visual, int *ldv, npy_complex64 *t, int *ldt, npy_complex64 *c, int *ldc, npy_complex64 *work, int *ldwork);
void BLAS_FUNC(clarzt)(char *direct, char *storev, int *n, int *k, npy_complex64 *Visual, int *ldv, npy_complex64 *tau, npy_complex64 *t, int *ldt);
...
void BLAS_FUNC(ctgsja)(char *jobu, char *jobv, char *jobq, int *m, int *p, int *n, int *k, int *l, npy_complex64 *a, int *lda, npy_complex64 *b, int *ldb, float *tola, float *tolb, float *alpha, float *beta, npy_complex64 *u, int *ldu, npy_complex64 *Visual, int *ldv, npy_complex64 *q, int *ldq, npy_complex64 *work, int *ncycle, int *info);
...
void BLAS_FUNC(ctpmqrt)(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, npy_complex64 *Visual, int *ldv, npy_complex64 *t, int *ldt, npy_complex64 *a, int *lda, npy_complex64 *b, int *ldb, npy_complex64 *work, int *info);
...
void BLAS_FUNC(ctprfb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, npy_complex64 *Visual, int *ldv, npy_complex64 *t, int *ldt, npy_complex64 *a, int *lda, npy_complex64 *b, int *ldb, npy_complex64 *work, int *ldwork);
...
void BLAS_FUNC(dgebak)(char *job, char *side, int *n, int *ilo, int *ihi, double *scale, int *m, double *Visual, int *ldv, int *info);
...
void BLAS_FUNC(dgejsv)(char *joba, char *jobu, char *jobv, char *jobr, char *jobt, char *jobp, int *m, int *n, double *a, int *lda, double *sva, double *u, int *ldu, double *Visual, int *ldv, double *work, int *lwork, int *iwork, int *info);
...
void BLAS_FUNC(dgemqrt)(char *side, char *trans, int *m, int *n, int *k, int *nb, double *Visual, int *ldv, double *t, int *ldt, double *c, int *ldc, double *work, int *info);
...
void BLAS_FUNC(dgesvj)(char *joba, char *jobu, char *jobv, int *m, int *n, double *a, int *lda, double *sva, int *mv, double *Visual, int *ldv, double *work, int *lwork, int *info);
...
void BLAS_FUNC(dggbak)(char *job, char *side, int *n, int *ilo, int *ihi, double *lscale, double *rscale, int *m, double *Visual, int *ldv, int *info);
...
void BLAS_FUNC(dgsvj0)(char *jobv, int *m, int *n, double *a, int *lda, double *d, double *sva, int *mv, double *Visual, int *ldv, double *eps, double *sfmin, double *tol, int *nsweep, double *work, int *lwork, int *info);
void BLAS_FUNC(dgsvj1)(char *jobv, int *m, int *n, int *n1, double *a, int *lda, double *d, double *sva, int *mv, double *Visual, int *ldv, double *eps, double *sfmin, double *tol, int *nsweep, double *work, int *lwork, int *info);
...
void BLAS_FUNC(dlacn2)(int *n, double *Visual, double *x, int *isgn, double *est, int *kase, int *isave);
void BLAS_FUNC(dlacon)(int *n, double *Visual, double *x, int *isgn, double *est, int *kase);
...
void BLAS_FUNC(dlaqr1)(int *n, double *h, int *ldh, double *sr1, double *si1, double *sr2, double *si2, double *Visual);
void BLAS_FUNC(dlaqr2)(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, double *h, int *ldh, int *iloz, int *ihiz, double *z, int *ldz, int *ns, int *nd, double *sr, double *si, double *Visual, int *ldv, int *nh, double *t, int *ldt, int *nv, double *wv, int *ldwv, double *work, int *lwork);
void BLAS_FUNC(dlaqr3)(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, double *h, int *ldh, int *iloz, int *ihiz, double *z, int *ldz, int *ns, int *nd, double *sr, double *si, double *Visual, int *ldv, int *nh, double *t, int *ldt, int *nv, double *wv, int *ldwv, double *work, int *lwork);
...
void BLAS_FUNC(dlaqr5)(int *wantt, int *wantz, int *kacc22, int *n, int *ktop, int *kbot, int *nshfts, double *sr, double *si, double *h, int *ldh, int *iloz, int *ihiz, double *z, int *ldz, double *Visual, int *ldv, double *u, int *ldu, int *nv, double *wv, int *ldwv, int *nh, double *wh, int *ldwh);
...
void BLAS_FUNC(dlarf)(char *side, int *m, int *n, double *Visual, int *incv, double *tau, double *c, int *ldc, double *work);
void BLAS_FUNC(dlarfb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, double *Visual, int *ldv, double *t, int *ldt, double *c, int *ldc, double *work, int *ldwork);
...
void BLAS_FUNC(dlarft)(char *direct, char *storev, int *n, int *k, double *Visual, int *ldv, double *tau, double *t, int *ldt);
void BLAS_FUNC(dlarfx)(char *side, int *m, int *n, double *Visual, double *tau, double *c, int *ldc, double *work);
...
void BLAS_FUNC(dlarz)(char *side, int *m, int *n, int *l, double *Visual, int *incv, double *tau, double *c, int *ldc, double *work);
void BLAS_FUNC(dlarzb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, double *Visual, int *ldv, double *t, int *ldt, double *c, int *ldc, double *work, int *ldwork);
void BLAS_FUNC(dlarzt)(char *direct, char *storev, int *n, int *k, double *Visual, int *ldv, double *tau, double *t, int *ldt);
...
void BLAS_FUNC(dtgsja)(char *jobu, char *jobv, char *jobq, int *m, int *p, int *n, int *k, int *l, double *a, int *lda, double *b, int *ldb, double *tola, double *tolb, double *alpha, double *beta, double *u, int *ldu, double *Visual, int *ldv, double *q, int *ldq, double *work, int *ncycle, int *info);
...
void BLAS_FUNC(dtpmqrt)(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, double *Visual, int *ldv, double *t, int *ldt, double *a, int *lda, double *b, int *ldb, double *work, int *info);
...
void BLAS_FUNC(dtprfb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, double *Visual, int *ldv, double *t, int *ldt, double *a, int *lda, double *b, int *ldb, double *work, int *ldwork);
...
void BLAS_FUNC(sgebak)(char *job, char *side, int *n, int *ilo, int *ihi, float *scale, int *m, float *Visual, int *ldv, int *info);
...
void BLAS_FUNC(sgejsv)(char *joba, char *jobu, char *jobv, char *jobr, char *jobt, char *jobp, int *m, int *n, float *a, int *lda, float *sva, float *u, int *ldu, float *Visual, int *ldv, float *work, int *lwork, int *iwork, int *info);
...
void BLAS_FUNC(sgemqrt)(char *side, char *trans, int *m, int *n, int *k, int *nb, float *Visual, int *ldv, float *t, int *ldt, float *c, int *ldc, float *work, int *info);
...
void BLAS_FUNC(sgesvj)(char *joba, char *jobu, char *jobv, int *m, int *n, float *a, int *lda, float *sva, int *mv, float *Visual, int *ldv, float *work, int *lwork, int *info);
...
void BLAS_FUNC(sggbak)(char *job, char *side, int *n, int *ilo, int *ihi, float *lscale, float *rscale, int *m, float *Visual, int *ldv, int *info);
...
void BLAS_FUNC(sgsvj0)(char *jobv, int *m, int *n, float *a, int *lda, float *d, float *sva, int *mv, float *Visual, int *ldv, float *eps, float *sfmin, float *tol, int *nsweep, float *work, int *lwork, int *info);
void BLAS_FUNC(sgsvj1)(char *jobv, int *m, int *n, int *n1, float *a, int *lda, float *d, float *sva, int *mv, float *Visual, int *ldv, float *eps, float *sfmin, float *tol, int *nsweep, float *work, int *lwork, int *info);
...
void BLAS_FUNC(slacn2)(int *n, float *Visual, float *x, int *isgn, float *est, int *kase, int *isave);
void BLAS_FUNC(slacon)(int *n, float *Visual, float *x, int *isgn, float *est, int *kase);
...
void BLAS_FUNC(slaqr1)(int *n, float *h, int *ldh, float *sr1, float *si1, float *sr2, float *si2, float *Visual);
void BLAS_FUNC(slaqr2)(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, float *h, int *ldh, int *iloz, int *ihiz, float *z, int *ldz, int *ns, int *nd, float *sr, float *si, float *Visual, int *ldv, int *nh, float *t, int *ldt, int *nv, float *wv, int *ldwv, float *work, int *lwork);
void BLAS_FUNC(slaqr3)(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, float *h, int *ldh, int *iloz, int *ihiz, float *z, int *ldz, int *ns, int *nd, float *sr, float *si, float *Visual, int *ldv, int *nh, float *t, int *ldt, int *nv, float *wv, int *ldwv, float *work, int *lwork);
...
void BLAS_FUNC(slaqr5)(int *wantt, int *wantz, int *kacc22, int *n, int *ktop, int *kbot, int *nshfts, float *sr, float *si, float *h, int *ldh, int *iloz, int *ihiz, float *z, int *ldz, float *Visual, int *ldv, float *u, int *ldu, int *nv, float *wv, int *ldwv, int *nh, float *wh, int *ldwh);
...
void BLAS_FUNC(slarf)(char *side, int *m, int *n, float *Visual, int *incv, float *tau, float *c, int *ldc, float *work);
void BLAS_FUNC(slarfb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, float *Visual, int *ldv, float *t, int *ldt, float *c, int *ldc, float *work, int *ldwork);
...
void BLAS_FUNC(slarft)(char *direct, char *storev, int *n, int *k, float *Visual, int *ldv, float *tau, float *t, int *ldt);
void BLAS_FUNC(slarfx)(char *side, int *m, int *n, float *Visual, float *tau, float *c, int *ldc, float *work);
...
void BLAS_FUNC(slarz)(char *side, int *m, int *n, int *l, float *Visual, int *incv, float *tau, float *c, int *ldc, float *work);
void BLAS_FUNC(slarzb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, float *Visual, int *ldv, float *t, int *ldt, float *c, int *ldc, float *work, int *ldwork);
void BLAS_FUNC(slarzt)(char *direct, char *storev, int *n, int *k, float *Visual, int *ldv, float *tau, float *t, int *ldt);
...
void BLAS_FUNC(stgsja)(char *jobu, char *jobv, char *jobq, int *m, int *p, int *n, int *k, int *l, float *a, int *lda, float *b, int *ldb, float *tola, float *tolb, float *alpha, float *beta, float *u, int *ldu, float *Visual, int *ldv, float *q, int *ldq, float *work, int *ncycle, int *info);
...
void BLAS_FUNC(stpmqrt)(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, float *Visual, int *ldv, float *t, int *ldt, float *a, int *lda, float *b, int *ldb, float *work, int *info);
...
void BLAS_FUNC(stprfb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, float *Visual, int *ldv, float *t, int *ldt, float *a, int *lda, float *b, int *ldb, float *work, int *ldwork);
...
void BLAS_FUNC(zgebak)(char *job, char *side, int *n, int *ilo, int *ihi, double *scale, int *m, npy_complex128 *Visual, int *ldv, int *info);
...
void BLAS_FUNC(zgemqrt)(char *side, char *trans, int *m, int *n, int *k, int *nb, npy_complex128 *Visual, int *ldv, npy_complex128 *t, int *ldt, npy_complex128 *c, int *ldc, npy_complex128 *work, int *info);
...
void BLAS_FUNC(zggbak)(char *job, char *side, int *n, int *ilo, int *ihi, double *lscale, double *rscale, int *m, npy_complex128 *Visual, int *ldv, int *info);
...
void BLAS_FUNC(zlacn2)(int *n, npy_complex128 *Visual, npy_complex128 *x, double *est, int *kase, int *isave);
void BLAS_FUNC(zlacon)(int *n, npy_complex128 *Visual, npy_complex128 *x, double *est, int *kase);
...
void BLAS_FUNC(zlaein)(int *rightv, int *noinit, int *n, npy_complex128 *h, int *ldh, npy_complex128 *w, npy_complex128 *Visual, npy_complex128 *b, int *ldb, double *rwork, double *eps3, double *smlnum, int *info);
...
void BLAS_FUNC(zlaqr1)(int *n, npy_complex128 *h, int *ldh, npy_complex128 *s1, npy_complex128 *s2, npy_complex128 *Visual);
void BLAS_FUNC(zlaqr2)(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, npy_complex128 *h, int *ldh, int *iloz, int *ihiz, npy_complex128 *z, int *ldz, int *ns, int *nd, npy_complex128 *sh, npy_complex128 *Visual, int *ldv, int *nh, npy_complex128 *t, int *ldt, int *nv, npy_complex128 *wv, int *ldwv, npy_complex128 *work, int *lwork);
void BLAS_FUNC(zlaqr3)(int *wantt, int *wantz, int *n, int *ktop, int *kbot, int *nw, npy_complex128 *h, int *ldh, int *iloz, int *ihiz, npy_complex128 *z, int *ldz, int *ns, int *nd, npy_complex128 *sh, npy_complex128 *Visual, int *ldv, int *nh, npy_complex128 *t, int *ldt, int *nv, npy_complex128 *wv, int *ldwv, npy_complex128 *work, int *lwork);
...
void BLAS_FUNC(zlaqr5)(int *wantt, int *wantz, int *kacc22, int *n, int *ktop, int *kbot, int *nshfts, npy_complex128 *s, npy_complex128 *h, int *ldh, int *iloz, int *ihiz, npy_complex128 *z, int *ldz, npy_complex128 *Visual, int *ldv, npy_complex128 *u, int *ldu, int *nv, npy_complex128 *wv, int *ldwv, int *nh, npy_complex128 *wh, int *ldwh);
...
void BLAS_FUNC(zlarf)(char *side, int *m, int *n, npy_complex128 *Visual, int *incv, npy_complex128 *tau, npy_complex128 *c, int *ldc, npy_complex128 *work);
void BLAS_FUNC(zlarfb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, npy_complex128 *Visual, int *ldv, npy_complex128 *t, int *ldt, npy_complex128 *c, int *ldc, npy_complex128 *work, int *ldwork);
...
void BLAS_FUNC(zlarft)(char *direct, char *storev, int *n, int *k, npy_complex128 *Visual, int *ldv, npy_complex128 *tau, npy_complex128 *t, int *ldt);
void BLAS_FUNC(zlarfx)(char *side, int *m, int *n, npy_complex128 *Visual, npy_complex128 *tau, npy_complex128 *c, int *ldc, npy_complex128 *work);
...
void BLAS_FUNC(zlarz)(char *side, int *m, int *n, int *l, npy_complex128 *Visual, int *incv, npy_complex128 *tau, npy_complex128 *c, int *ldc, npy_complex128 *work);
void BLAS_FUNC(zlarzb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, npy_complex128 *Visual, int *ldv, npy_complex128 *t, int *ldt, npy_complex128 *c, int *ldc, npy_complex128 *work, int *ldwork);
void BLAS_FUNC(zlarzt)(char *direct, char *storev, int *n, int *k, npy_complex128 *Visual, int *ldv, npy_complex128 *tau, npy_complex128 *t, int *ldt);
...
void BLAS_FUNC(ztgsja)(char *jobu, char *jobv, char *jobq, int *m, int *p, int *n, int *k, int *l, npy_complex128 *a, int *lda, npy_complex128 *b, int *ldb, double *tola, double *tolb, double *alpha, double *beta, npy_complex128 *u, int *ldu, npy_complex128 *Visual, int *ldv, npy_complex128 *q, int *ldq, npy_complex128 *work, int *ncycle, int *info);
...
void BLAS_FUNC(ztpmqrt)(char *side, char *trans, int *m, int *n, int *k, int *l, int *nb, npy_complex128 *Visual, int *ldv, npy_complex128 *t, int *ldt, npy_complex128 *a, int *lda, npy_complex128 *b, int *ldb, npy_complex128 *work, int *info);
...
void BLAS_FUNC(ztprfb)(char *side, char *trans, char *direct, char *storev, int *m, int *n, int *k, int *l, npy_complex128 *Visual, int *ldv, npy_complex128 *t, int *ldt, npy_complex128 *a, int *lda, npy_complex128 *b, int *ldb, npy_complex128 *work, int *ldwork);
