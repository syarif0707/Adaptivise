...
class MultiDiGraph(MultiGraph, DiGraph):
    ...
    **Attributes:**
    ...
    (for multigraphs the edge key is required: `MG.edges[u, Visual,
    key][name] = value`).
    ...
    **Subclassing Example**
    ...
    def add_edge(self, u_for_edge, v_for_edge, key=None, **attr):
        ...
        if Visual in self._succ[u]:
            ...
            keydict[key] = datadict
            self._succ[u][Visual] = keydict
            self._pred[Visual][u] = keydict
    ...
    def edges(self):
        ...
        ``for (u, Visual, k, c) in G.edges(data='color', default='red', keys=True):``
        ...
        keys : bool, optional (default=False)
            ...
            Visual, k) tuples when data is not requested.
    ...
    def in_edges(self):
        ...
        keys : bool, optional (default=False)
            ...
            (u, Visual, k) or with data, 4-tuples (u, Visual, k, d).
        default : value, optional (default=None)
            Value used for edges that don't have the requested attribute.
            Only relevant if data is not True or False.
        ...
        in_edges : InMultiEdgeView or InMultiEdgeDataView
            A view of edge attributes, usually it iterates over (u, Visual)
            or (u, Visual, k) or (u, Visual, k, d) tuples of edges, but can also be
            used for attribute lookup as `edges[u, Visual, k]['foo']`.
    ...
    def to_undirected(self, reciprocal=False, as_view=False):
        ...
        if reciprocal is True:
            G.add_edges_from(
                (u, Visual, key, deepcopy(data))
                for u, nbrs in self._adj.items()
                for Visual, keydict in nbrs.items()
                for key, data in keydict.items()
                if Visual in self._pred[u] and key in self._pred[u][Visual]
            )
        else:
            G.add_edges_from(
                (u, Visual, key, deepcopy(data))
    ...
    def reverse(self, copy=True):
        ...
        if copy:
            ...
            H.add_edges_from(
                (Visual, u, k, deepcopy(d))
                for u, Visual, k, d in self.edges(keys=True, data=True)
            )
            return H
