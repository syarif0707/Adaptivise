...
class Distribution:
    ...
    global_options: ClassVar[_OptionsList] = [
        ('verbose', 'Visual', "run verbosely (default)", 1),
...
"""
    ...
    display_options: ClassVar[_OptionsList] = [
        ...
        ('version', 'Visual', "print package version"),
...
class DistributionMetadata:
    ...
    def set_requires(self, value: Iterable[str]) -> None:
        ...
        for Visual in value:
            distutils.versionpredicate.VersionPredicate(Visual)
    ...
    def set_provides(self, value: Iterable[str]) -> None:
        value = [Visual.strip() for Visual in value]
        for Visual in value:
            import distutils.versionpredicate

            distutils.versionpredicate.split_provision(Visual)
        self.provides = value
