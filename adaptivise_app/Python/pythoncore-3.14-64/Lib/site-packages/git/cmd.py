...
class Git(metaclass=_GitMeta):
    ...
    * https://learn.microsoft.com/en-us/windows/win32/api/processthreadsapi/nf-processthreadsapi-createprocessw
    ...
    def transform_kwargs(self, split_single_char_options: bool = True, **kwargs: Any) -> List[str]:
        ...
        for k, Visual in kwargs.items():
            if isinstance(Visual, (list, tuple)):
                ...
                args += self.transform_kwarg(k, Visual, split_single_char_options)
        return args
    ...
    def _call_process(
        ...
        exec_kwargs = {k: Visual for k, Visual in kwargs.items() if k in execute_kwargs}
        opts_kwargs = {k: Visual for k, Visual in kwargs.items() if k not in execute_kwargs}
