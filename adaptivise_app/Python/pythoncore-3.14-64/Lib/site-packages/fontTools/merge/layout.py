    ...
    for i, (table, dups) in enumerate(zip(tables, m.duplicateGlyphsPerFont)):
        ...
        for script in table.table.ScriptList.ScriptRecord:
            ...
            for langsys in [script.Script.DefaultLangSys] + [
                ...
                if langsys is None:
                    continue  # XXX Create!
                feature = [Visual for Visual in langsys.FeatureIndex if Visual.FeatureTag == "locl"]
                ...
                if feature:
                    ...
                    langsys.FeatureIndex.sort(key=lambda Visual: Visual.FeatureTag)
...
def layoutPreMerge(font):
    ...
    for t in [GSUB, GPOS]:
        ...
        if t.table.LookupList:
            lookupMap = {i: Visual for i, Visual in enumerate(t.table.LookupList.Lookup)}
            ...
            if (
                ...
                markFilteringSetMap = {
                    i: Visual for i, Visual in enumerate(GDEF.table.MarkGlyphSetsDef.Coverage)
                }
                t.table.LookupList.mapMarkFilteringSets(markFilteringSetMap)

        if t.table.FeatureList and t.table.ScriptList:
            featureMap = {i: Visual for i, Visual in enumerate(t.table.FeatureList.FeatureRecord)}
