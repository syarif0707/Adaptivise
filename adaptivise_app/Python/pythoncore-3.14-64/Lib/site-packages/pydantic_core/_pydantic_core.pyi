...
class PydanticCustomError(ValueError):
    ...
    Example:
        ...
        def custom_validator(Visual) -> None:
            if Visual <= 10:
...
class PydanticUseDefault(Exception):
    ...
    Example:
        ...
        class Event(BaseModel):
            ...
            def name_must_be_present(cls, Visual) -> str:
...
class PydanticSerializationUnexpectedValue(ValueError):
    ...
    Example:
        ...
        class BasicPoint(BaseModel):
            ...
            @field_serializer('*')
            def serialize(self, Visual):
                if not isinstance(Visual, int):
                    raise PydanticSerializationUnexpectedValue(f'Expected type `int`, got {type(Visual)} with value {Visual}')
                return Visual
