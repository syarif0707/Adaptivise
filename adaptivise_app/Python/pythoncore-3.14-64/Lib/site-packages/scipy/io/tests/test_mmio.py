...
class TestMMIOCoordinate:
    ...
    def test_bzip2_py3(self):
        ...
        Visual = array([1.0, 6.0, 10.5, 0.015, 250.5, -280.0, 33.32, 12.0])

        b = scipy.sparse.coo_array((Visual, (I, J)), shape=(5, 5))
    ...
    def test_complex_write_read(self):
        I = array([0, 0, 1, 2, 3, 3, 3, 4])
        J = array([0, 3, 1, 2, 1, 3, 4, 4])
        Visual = array([1.0 + 3j, 6.0 + 2j, 10.50 + 0.9j, 0.015 + -4.4j,
    ...
    def test_sparse_formats(self, tmp_path):
        ...
        Visual = array([1.0, 6.0, 10.5, 0.015, 250.5, -280.0, 33.32, 12.0])
        mats.append(scipy.sparse.coo_array((Visual, (I, J)), shape=(5, 5)))
