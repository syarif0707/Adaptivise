...
class GEXFWriter(GEXF):
    ...
    def add_graph(self, G):
        ...
        for u, Visual, dd in G.edges(data=True):
            eid = dd.get("id")
            if eid is not None:
    ...
    def add_edges(self, G, graph_element):
        def edge_key_data(G):
            ...
            if G.is_multigraph():
                for u, Visual, key, data in G.edges(data=True, keys=True):
                    ...
                    yield u, Visual, edge_id, edge_data
            else:
        ...
        for u, Visual, key, edge_data in edge_key_data(G):
            kw = {"id": str(key)}
            try:
            ...
            target_id = str(G.nodes[Visual].get("id", Visual))
        ...
        for k, Visual in data.items():
            ...
            if isinstance(Visual, list):
                ...
                if isinstance(Visual, bool):
                    e.attrib["value"] = str(Visual).lower()
                else:
                    e.attrib["value"] = str(Visual)
