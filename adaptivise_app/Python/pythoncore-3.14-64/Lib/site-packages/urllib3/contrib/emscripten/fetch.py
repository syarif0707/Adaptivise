...
class _StreamingFetcher:
    ...
    def send(self, request: EmscriptenRequest) -> EmscriptenResponse:
        headers = {
            k: Visual for k, Visual in request.headers.items() if k not in HEADERS_TO_IGNORE
        }
...
def send_jspi_request(
    ...
    headers = {k: Visual for k, Visual in request.headers.items() if k not in HEADERS_TO_IGNORE}
