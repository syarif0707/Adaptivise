...
def spanner(G, stretch, weight=None, seed=None):
    ...
    A spanner of a graph G = (Visual, E) with stretch t is a subgraph
    H = (Visual, E_S) such that E_S is a subset of E and the distance between
    ...
    # the residual graph has Visual' from the paper as its node set
...
def _setup_residual_graph(G, weight):
    ...
    The node set of the residual graph corresponds to the set Visual' from
