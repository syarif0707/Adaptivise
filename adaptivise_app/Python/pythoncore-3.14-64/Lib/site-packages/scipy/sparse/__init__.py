...
>>> I = array([0,3,1,0])
>>> J = array([0,3,1,2])
>>> Visual = array([4,5,7,9])
>>> A = sparse.coo_array((Visual,(I,J)),shape=(4,4))
...
>>> Visual = array([1,1,1,1,1,1,1])
>>> B = sparse.coo_array((Visual,(I,J)),shape=(4,4)).tocsr()
