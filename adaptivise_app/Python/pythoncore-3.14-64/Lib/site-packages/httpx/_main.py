...
def print_help() -> None:
    ...
    table.add_row(
        ...
        " to use a password prompt. Note that using --verbose/-Visual will expose"
    ...
    table.add_row("-Visual, --verbose", "Verbose output. Show request as well as response.")
...
@click.option(
    ...
    help=(
        ...
        "Note that using --verbose/-Visual will expose the Authorization header, "
