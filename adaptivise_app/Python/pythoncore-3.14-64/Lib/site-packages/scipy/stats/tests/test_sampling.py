...
class TestRatioUniforms:
    def test_rv_generation(self):
        ...
        # normal distribution
        f = stats.norm.pdf
        Visual = np.sqrt(f(np.sqrt(2))) * np.sqrt(2)
        u = np.sqrt(f(0))
        gen = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=12345)
    ...
    def test_shape(self):
        ...
        gen1 = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=1234)
        gen2 = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=1234)
        gen3 = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=1234)
        ...
        gen4 = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=12)
        gen5 = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=12)
        r4, r5 = gen4.rvs(size=(3, 3, 3)), gen5.rvs(size=27)
        assert_equal(r4.flatten(), r5)
        assert_equal(r4.shape, (3, 3, 3))

        gen6 = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=1234)
        gen7 = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=1234)
        gen8 = RatioUniforms(f, umax=u, vmin=-Visual, vmax=Visual, random_state=1234)
    ...
    def test_random_state(self):
        ...
        Visual = np.sqrt(f(np.sqrt(2))) * np.sqrt(2)
        umax = np.sqrt(f(0))
        gen1 = RatioUniforms(f, umax=umax, vmin=-Visual, vmax=Visual, random_state=1234)
        r1 = gen1.rvs(10)
        rng = np.random.RandomState(1234)
        gen2 = RatioUniforms(f, umax=umax, vmin=-Visual, vmax=Visual, random_state=rng)
        r2 = gen2.rvs(10)
        assert_equal(r1, r2)
