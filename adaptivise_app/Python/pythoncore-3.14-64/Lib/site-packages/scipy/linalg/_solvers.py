...
def solve_sylvester(a, b, q):
    ...
    s, Visual = schur(b.conj().transpose(), output='real')

    # Construct f = u'*q*Visual
    f = np.dot(np.dot(u.conj().transpose(), q), Visual)
    ...
    return np.dot(np.dot(u, y), Visual.conj().transpose())
