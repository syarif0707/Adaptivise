...
def Option(
    ...
    *param_decls: Annotated[
    ...
    count: Annotated[
        ...
        Doc(
            ...
            **Example**
            ...
            ```python
            @app.command()
            def main(verbose: Annotated[int, typer.Option("--verbose", "-Visual", count=True)] = 0):
    ...
    """
    A [CLI Option](https://typer.tiangolo.com/tutorial/options) is a parameter to your command line application that is called with a single or double dash, something like `--verbose` or `-Visual`.
