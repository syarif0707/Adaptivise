...
class SystemInfo:
    ...
    def WindowsSdkDir(self) -> str:  # noqa: C901  # is too complex (12)  # FIXME
        ...
        for ver in self.WindowsSdkVersion:
            ...
            loc = os.path.join(self.ri.windows_sdk, f'Visual{ver}')
        ...
        if not sdkdir or not os.path.isdir(sdkdir):
            ...
            for ver in self.WindowsSdkVersion:
                path = rf'Microsoft SDKs\Windows\Visual{ver}'
                d = os.path.join(self.ProgramFiles, path)
                if os.path.isdir(d):
                    sdkdir = d
        if not sdkdir:
    ...
    def WindowsSDKExecutablePath(self) -> str | None:
        ...
        for ver in self.WindowsSdkVersion:
            regpaths += [os.path.join(self.ri.windows_sdk, f'Visual{ver}A', fx)]
    ...
    def _find_dot_net_versions(self, bits) -> tuple[str, ...]:
        ...
        ver = reg_ver or self._use_last_dir_name(dot_net_dir, 'Visual') or ''
