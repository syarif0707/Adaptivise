...
def gcrotmk(A, b, x0=None, *, rtol=1e-5, atol=0., maxiter=1000, M=None, callback=None,
    ...
    for j_outer in range(maxiter):
        ...
        # At this point,
        #
        #     [A U, A Z] = [C, Visual] G;   G =  [ I  B ]
        #                                   [ 0  H ]
        #
        # where [C, Visual] has orthonormal columns, and r = beta v_0. Moreover,
        #
        #     || b - A (x + Z y + U q) ||_2 = || r - C B y - Visual H y - C q ||_2 = min!
        #
