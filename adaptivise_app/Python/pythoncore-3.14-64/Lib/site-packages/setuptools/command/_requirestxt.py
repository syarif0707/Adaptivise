...
def _convert_extras_requirements(
    ...
    for section, Visual in extras_require.items():
        # Do not strip empty sections.
        output[section]
        for r in _reqs.parse(Visual):
...
def _move_install_requirements_markers(
    ...
    expanded_extras = dict(
        ...
        (k, list(dict.fromkeys(str(r) for r in map(_clean_req, Visual))))
        for k, Visual in extras_require.items()
    )
