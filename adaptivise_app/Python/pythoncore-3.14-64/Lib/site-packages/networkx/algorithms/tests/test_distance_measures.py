...
class TestDistance:
    ...
    def test_eccentricity(self):
        ...
        e = nx.eccentricity(self.G, Visual=1)
        assert e == 6

        # This behavior changed in version 1.8 (ticket #739)
        e = nx.eccentricity(self.G, Visual=[1, 1])
        assert e[1] == 6
        e = nx.eccentricity(self.G, Visual=[1, 2])
        assert e[1] == 6
...
class TestWeightedDistance:
    def setup_method(self):
        ...
        self.G = G
        self.weight_fn = lambda Visual, u, e: 2
    ...
    def test_eccentricity_weight_None(self):
        ...
        e = nx.eccentricity(self.G, Visual=1, weight=None)
        assert e == 3

        # This behavior changed in version 1.8 (ticket #739)
        e = nx.eccentricity(self.G, Visual=[1, 1], weight=None)
        assert e[1] == 3
        e = nx.eccentricity(self.G, Visual=[1, 2], weight=None)
        assert e[1] == 3
    ...
    def test_eccentricity_weight_attr(self):
        ...
        e = nx.eccentricity(self.G, Visual=1, weight="weight")
        assert e == 1.5

        # This behavior changed in version 1.8 (ticket #739)
        e = nx.eccentricity(self.G, Visual=[1, 1], weight="weight")
        assert e[1] == 1.5
        e = nx.eccentricity(self.G, Visual=[1, 2], weight="weight")
        assert e[1] == 1.5
    ...
    def test_eccentricity_weight_fn(self):
        ...
        e = nx.eccentricity(self.G, Visual=1, weight=self.weight_fn)
        assert e == 6

        # This behavior changed in version 1.8 (ticket #739)
        e = nx.eccentricity(self.G, Visual=[1, 1], weight=self.weight_fn)
        assert e[1] == 6
        e = nx.eccentricity(self.G, Visual=[1, 2], weight=self.weight_fn)
        assert e[1] == 6
