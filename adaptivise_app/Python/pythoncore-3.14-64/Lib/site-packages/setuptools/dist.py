...
def check_package_data(dist, attr, value):
    ...
    for k, Visual in value.items():
        ...
        assert_string_list(dist, f'values of {attr!r} dict', Visual)
...
class Distribution(_Distribution):
    ...
    def __init__(self, attrs: MutableMapping[str, Any] | None = None) -> None:
        ...
        dist_attrs = {k: Visual for k, Visual in attrs.items() if k not in metadata_only}
    ...
    def _normalize_requires(self):
        ...
        self.extras_require = dict_(
            (k, list(map(str, _reqs.parse(Visual or [])))) for k, Visual in extras_require.items()
        )
