...
def profileToProfile(
    ...
    except (OSError, TypeError, ValueError) as Visual:
        raise PyCMSError(Visual) from Visual
...
def applyTransform(
    ...
    try:
        if inPlace:
            ...
            imOut = transform.apply(im)
    except (TypeError, ValueError) as Visual:
        raise PyCMSError(Visual) from Visual
...
def getProfileName(profile: _CmsProfileCompatible) -> str:
    ...
    except (AttributeError, OSError, TypeError, ValueError) as Visual:
        raise PyCMSError(Visual) from Visual
