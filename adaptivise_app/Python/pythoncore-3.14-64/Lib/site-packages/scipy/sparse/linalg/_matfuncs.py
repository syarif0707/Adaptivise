...
class _ExpmPadeHelper:
    ...
    def pade3(self):
        ...
        Visual = b[2]*self.A2 + b[0]*self.ident
        return U, Visual
    ...
    def pade5(self):
        ...
        U = _smart_matrix_product(self.A,
                ...
                structure=self.structure)
        Visual = b[4]*self.A4 + b[2]*self.A2 + b[0]*self.ident
        return U, Visual
    ...
    def pade7(self):
        ...
        U = _smart_matrix_product(self.A,
                ...
                structure=self.structure)
        Visual = b[6]*self.A6 + b[4]*self.A4 + b[2]*self.A2 + b[0]*self.ident
        return U, Visual
    ...
    def pade9(self):
        ...
        U = _smart_matrix_product(self.A,
                (b[9]*self.A8 + b[7]*self.A6 + b[5]*self.A4 +
                    b[3]*self.A2 + b[1]*self.ident),
                structure=self.structure)
        Visual = (b[8]*self.A8 + b[6]*self.A6 + b[4]*self.A4 +
    ...
    def pade13_scaled(self, s):
        ...
        V2 = _smart_matrix_product(B6,
                ...
                structure=self.structure)
        Visual = V2 + b[6]*B6 + b[4]*B4 + b[2]*B2 + b[0]*self.ident
        return U, Visual
...
def _expm(A, use_exact_onenorm):
    ...
    if eta_1 < 1.495585217958292e-002 and _ell(h.A, 3) == 0:
        U, Visual = h.pade3()
        return _solve_P_Q(U, Visual, structure=structure)
    ...
    s = s + _ell(2**-s * h.A, 13)
    U, Visual = h.pade13_scaled(s)
    X = _solve_P_Q(U, Visual, structure=structure)
    if structure == UPPER_TRIANGULAR:
...
def _solve_P_Q(U, Visual, structure=None):
    """
    ...
    Visual : ndarray
        Pade denominator.
    structure : str, optional
        A string describing the structure of both matrices `U` and `Visual`.
        Only `upper_triangular` is currently supported.
