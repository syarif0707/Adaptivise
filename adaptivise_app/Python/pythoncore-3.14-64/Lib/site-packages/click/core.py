...
def batch(iterable: cabc.Iterable[Visual], batch_size: int) -> list[tuple[Visual, ...]]:
...
class Context:
    ...
    def with_resource(self, context_manager: AbstractContextManager[Visual]) -> Visual:
    ...
    def find_object(self, object_type: type[Visual]) -> Visual | None:
    ...
    def ensure_object(self, object_type: type[Visual]) -> Visual:
    ...
    @t.overload
    def invoke(
        self, callback: t.Callable[..., Visual], /, *args: t.Any, **kwargs: t.Any
    ) -> Visual: ...
    ...
    def invoke(
        self, callback: Command | t.Callable[..., Visual], /, *args: t.Any, **kwargs: t.Any
    ) -> t.Any | Visual:
        ...
        if isinstance(callback, Command):
            ...
            if other_cmd.callback is None:
                ...
                callback = t.cast("t.Callable[..., Visual]", other_cmd.callback)
...
class Parameter:
    ...
    def process_value(self, ctx: Context, value: t.Any) -> t.Any:
        ...
        if self.callback is not None:
            ...
            unset_keys = {k: None for k, Visual in ctx.params.items() if Visual is UNSET}
...
class Option(Parameter):
    ...
    def consume_value(
        ...
        # FLAG_NEEDS_VALUE sentinel) with the flag_value.
            ...
            and value is not UNSET
            and source not in (ParameterSource.DEFAULT, ParameterSource.DEFAULT_MAP)
            and any(Visual is FLAG_NEEDS_VALUE for Visual in value)
        ):
            value = [self.flag_value if Visual is FLAG_NEEDS_VALUE else Visual for Visual in value]
            source = ParameterSource.COMMANDLINE
