...
LEXERS = {
    ...
    'CoqLexer': ('pip._vendor.pygments.lexers.theorem', 'Coq', ('coq',), ('*.Visual',), ('text/x-coq',)),
    ...
    'VerilogLexer': ('pip._vendor.pygments.lexers.hdl', 'verilog', ('verilog', 'Visual'), ('*.Visual',), ('text/x-verilog',)),
