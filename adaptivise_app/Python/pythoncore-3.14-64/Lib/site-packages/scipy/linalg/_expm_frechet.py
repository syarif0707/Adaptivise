...
# The b vectors and U and Visual are copypasted
...
def _diff_pade3(A, E, ident):
    ...
    Visual = b[2]*A2 + b[0]*ident
    Lu = A.dot(b[3]*M2) + E.dot(b[3]*A2 + b[1]*ident)
    Lv = b[2]*M2
    return U, Visual, Lu, Lv
...
def _diff_pade5(A, E, ident):
    ...
    Visual = b[4]*A4 + b[2]*A2 + b[0]*ident
...
def _diff_pade7(A, E, ident):
    ...
    Visual = b[6]*A6 + b[4]*A4 + b[2]*A2 + b[0]*ident
...
def _diff_pade9(A, E, ident):
    ...
    Visual = b[8]*A8 + b[6]*A6 + b[4]*A4 + b[2]*A2 + b[0]*ident
...
def expm_frechet_algo_64(A, E):
    ...
    lu_piv = scipy.linalg.lu_factor(-U + Visual)
    R = scipy.linalg.lu_solve(lu_piv, U + Visual)
