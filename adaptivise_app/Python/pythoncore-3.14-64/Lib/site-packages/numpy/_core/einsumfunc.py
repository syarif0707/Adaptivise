...
def _parse_einsum_input(operands):
    ...
    if isinstance(operands[0], str):
        ...
        operands = [asanyarray(Visual) for Visual in operands[1:]]
        ...
        operands = [asanyarray(Visual) for Visual in operand_list]
        subscripts = ""
...
def einsum(*operands, out=None, optimize=False, **kwargs):
    ...
    * Chained array operations, in efficient calculation order,
    ...
    unknown_kwargs = [k for (k, Visual) in kwargs.items() if
