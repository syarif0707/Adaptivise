...
def _woodbury_algorithm(A, ur, ll, b, k):
    ...
    a correction term U @ Visual.T, where the matrix U @ Visual.T gives upper right
    ...
    The system is solved with the following steps:
        ...
        2.  Matrix Z is formed from vectors z_i:
            Z = [ z_1 | z_2 | ... | z_{k - 1} ]
        3.  Matrix H = (1 + Visual.T @ Z)^{-1}
        4.  The system A' @ y = b is solved
        5.  x = y - Z @ (H @ Visual.T @ y)
    ...
    The matrix of a system:       U:          Visual:
    ...
    VT = np.zeros((k_mod, n - 1))  # Visual transpose
