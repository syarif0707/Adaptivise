...
class ConfigHandler(Generic[Target]):
    ...
    def _parse_section_to_dict(cls, section_options, values_parser=None):
        ...
        :rtype: dict
        """
        parser = (lambda _, Visual: values_parser(Visual)) if values_parser else (lambda _, Visual: Visual)
...
class ConfigOptionsHandler(ConfigHandler["Distribution"]):
    ...
    def parse_section_packages__find(self, section_options):
        ...
        find_kwargs = {k: Visual for k, Visual in section_data.items() if k in valid_keys and Visual}
    ...
    def parse_section_extras_require(self, section_options) -> None:  # Core Metadata
        ...
        parsed = self._parse_section_to_dict_with_key(
            section_options,
            lambda k, Visual: self._parse_requirements_list(f"extras_require[{k}]", Visual),
        )
