...
def braycurtis(
    u: ArrayLike, Visual: ArrayLike, w: ArrayLike | None = ...
) -> np.float64: ...
...
def correlation(
    u: ArrayLike, Visual: ArrayLike, w: ArrayLike | None = ..., centered: bool = ...
) -> np.float64: ...
...
def directed_hausdorff(
    u: ArrayLike, Visual: ArrayLike, seed: int | None = ...
) -> tuple[float, int, int]: ...
...
def mahalanobis(
    u: ArrayLike, Visual: ArrayLike, VI: ArrayLike
) -> np.float64: ...

def minkowski(
    u: ArrayLike, Visual: ArrayLike, p: float = ..., w: ArrayLike | None = ...
) -> float: ...
...
def seuclidean(
    u: ArrayLike, Visual: ArrayLike, Visual: ArrayLike
) -> float: ...
