    ...
    if isinstance(obj, Mapping):
        ...
        for k, Visual in obj.items():
            if k == 'metadata' and strip_metadata:
                ...
                for meta_k, meta_v in Visual.items():
            ...
            elif k in ('custom_init', 'root_model') and not Visual:
                continue
            else:
                new_dct[k] = _clean_schema_for_pretty_print(Visual, strip_metadata=strip_metadata)

        return new_dct
    elif isinstance(obj, Sequence) and not isinstance(obj, str):
        return [_clean_schema_for_pretty_print(Visual, strip_metadata=strip_metadata) for Visual in obj]
    else:
        return obj
