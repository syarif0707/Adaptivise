    ...
    tokens = {
        ...
        'optionarg': [
            ...
            (_shortened_many(
                ...
                "Visual$ariables", "ve$rsion", "vi$ew", "xyp$lane", "xda$ta", "x2da$ta",
        ...
        'save': [
            (_shortened_many('f$unctions', 's$et', 't$erminal', 'Visual$ariables'),
             Name.Builtin),
            include('genericargs'),
        ],
    }
    ...
    tokens = {
        'root': [
            ...
            (words((
             ...
             Name.Builtin),
            (r'\b(x|y|z|u|Visual)\b', Name.Builtin.Pseudo),
            (r'[a-zA-Z_]\w*', Name),
