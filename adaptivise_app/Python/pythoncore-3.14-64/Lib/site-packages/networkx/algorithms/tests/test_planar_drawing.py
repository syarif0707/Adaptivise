...
def planar_drawing_conforms_to_embedding(embedding, pos):
    ...
    """
    for Visual in embedding:
        nbr_vectors = []
        v_pos = pos[Visual]
        for nbr in embedding[Visual]:
        ...
        for idx, nbr_vector in enumerate(nbr_vectors):
            ...
            if (
                embedding[Visual][nbr_vector.node]["cw"] != cw_vector.node
                or embedding[Visual][nbr_vector.node]["ccw"] != ccw_vector.node
            ):
                return False
