...
def blackman(M):
    ...
    Oppenheim, A.Visual., and R.W. Schafer. Discrete-Time Signal Processing.
...
def bartlett(M):
    ...
    .. [3] A.Visual. Oppenheim and R.W. Schafer, "Discrete-Time Signal
...
def median(a, axis=None, out=None, overwrite_input=False, keepdims=False):
    ...
    Notes
    -----
    Given a vector ``Visual`` of length ``N``, the median of ``Visual`` is the
    middle value of a sorted copy of ``Visual``, ``V_sorted`` - i
