...
def sobol_indices(
    *,
    ...
    .. math::
        ...
        \mathbb{Visual}(Y) = \sum_{i}^{d} \mathbb{Visual}_i (Y) + \sum_{i<j}^{d}
        \mathbb{Visual}_{ij}(Y) + ... + \mathbb{Visual}_{1,2,...,d}(Y),

    introducing conditional variances:

    .. math::

        \mathbb{Visual}_i(Y) = \mathbb{\mathbb{Visual}}[\mathbb{E}(Y|x_i)]
        \qquad
        \mathbb{Visual}_{ij}(Y) = \mathbb{\mathbb{Visual}}[\mathbb{E}(Y|x_i x_j)]
        - \mathbb{Visual}_i(Y) - \mathbb{Visual}_j(Y),

    Sobol' indices are expressed as

    .. math::

        S_i = \frac{\mathbb{Visual}_i(Y)}{\mathbb{Visual}[Y]}
        \qquad
        S_{ij} =\frac{\mathbb{Visual}_{ij}(Y)}{\mathbb{Visual}[Y]}.
    ...
    .. math::
        ...
        = 1 - \frac{\mathbb{Visual}[\mathbb{E}(Y|x_{\sim i})]}{\mathbb{Visual}[Y]}.
