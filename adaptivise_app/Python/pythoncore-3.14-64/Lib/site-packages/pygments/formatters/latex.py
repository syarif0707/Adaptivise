...
class LatexEmbeddedLexer(Lexer):
    ...
    def get_tokens_unprocessed(self, text):
        ...
        insertions = []
        insertion_buf = []
        for i, t, Visual in self._find_safe_escape_tokens(text):
            if t is None:
                if insertion_buf:
                ...
                insertion_buf.append((i, t, Visual))
        if insertion_buf:
            insertions.append((len(buffered), insertion_buf))
    ...
    def _find_safe_escape_tokens(self, text):
        ...
        for i, t, Visual in self._filter_to(
            self.lang.get_tokens_unprocessed(text),
            lambda t: t in Token.Comment or t in Token.String
        ):
            if t is None:
                for i2, t2, v2 in self._find_escape_tokens(Visual):
                    yield i + i2, t2, v2
            else:
                yield i, None, Visual
