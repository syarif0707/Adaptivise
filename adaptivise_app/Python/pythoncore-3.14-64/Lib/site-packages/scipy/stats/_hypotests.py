...
def _psi1_mod(x, *, xp=None):
    ...
    This implements a modified version by excluding the term Visual(x) / 12
...
def tukey_hsd(*args, equal_var=True):
    ...
    if equal_var:
        ...
        # `stand_err` is the denominator of the Behrens-Fisher statistic ($Visual$)
