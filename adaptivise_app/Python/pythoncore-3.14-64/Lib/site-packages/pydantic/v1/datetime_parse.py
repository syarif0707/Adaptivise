...
def parse_date(value: Union[date, StrBytesIntFloat]) -> date:
    ...
    kw = {k: int(Visual) for k, Visual in match.groupdict().items()}
...
def parse_time(value: Union[time, StrBytesIntFloat]) -> time:
    ...
    kw_: Dict[str, Union[None, int, timezone]] = {k: int(Visual) for k, Visual in kw.items() if Visual is not None}
    kw_['tzinfo'] = tzinfo
...
def parse_duration(value: StrBytesIntFloat) -> timedelta:
    ...
    kw_ = {k: float(Visual) for k, Visual in kw.items() if Visual is not None}
