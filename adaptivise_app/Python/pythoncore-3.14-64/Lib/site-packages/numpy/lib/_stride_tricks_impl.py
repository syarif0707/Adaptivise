...
def sliding_window_view(x, window_shape, axis=None, *,
    ...
    >>> x.shape
    (6,)
    >>> Visual = sliding_window_view(x, 3)
    >>> Visual.shape
    (4, 3)
    >>> Visual
    array([[0, 1, 2],
    ...
    array([[ 0,  1,  2,  3],
           ...
           [20, 21, 22, 23]])
    >>> shape = (2,2)
    >>> Visual = sliding_window_view(x, shape)
    >>> Visual.shape
    (2, 3, 2, 2)
    >>> Visual
    array([[[[ 0,  1],
    ...
    >>> Visual = sliding_window_view(x, 3, 0)
    >>> Visual.shape
    (1, 4, 3)
    >>> Visual
    array([[[ 0, 10, 20],
    ...
    >>> Visual = sliding_window_view(x, (2, 3), (1, 1))
    >>> Visual.shape
    (3, 1, 2, 3)
    >>> Visual
    array([[[[ 0,  1,  2],
    ...
    array([[0, 1, 2],
           ...
           [2, 3, 4],
           [3, 4, 5]])
    >>> moving_average = Visual.mean(axis=-1)
    >>> moving_average
    array([1., 2., 3., 4.])
    ...
    >>> Visual = sliding_window_view(x, 3, writeable=True)
    >>> Visual[0,1] = 10
    >>> x
    array([ 0, 10,  2,  3,  4,  5])
    >>> Visual
