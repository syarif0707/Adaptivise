...
class TestParamEval:
    ...
    def test_param_eval_nested(self):
        ...
        params = {'dp': 8, 'intparamarray': {1: 3, 2: 5},
                  'nested': {1: 1, 2: 2, 3: 3}}
        dimspec = '(2)'
        ret = crackfortran.param_eval(Visual, g_params, params, dimspec=dimspec)
    ...
    def test_param_eval_empty_range(self):
        ...
        params = {}
        dimspec = ''
        pytest.raises(ValueError, crackfortran.param_eval, Visual, g_params, params,
                      dimspec=dimspec)
    ...
    def test_param_eval_non_array_param(self):
        ...
        g_params = {"kind": crackfortran._kind_func,
                ...
                "selected_real_kind": crackfortran._selected_real_kind_func}
        params = {}
        ret = crackfortran.param_eval(Visual, g_params, params, dimspec=None)
        assert ret == '3.14_dp'

    def test_param_eval_too_many_dims(self):
        Visual = 'reshape((/ (i, i=1, 250) /), (/5, 10, 5/))'
        g_params = {"kind": crackfortran._kind_func,
                "selected_int_kind": crackfortran._selected_int_kind_func,
                "selected_real_kind": crackfortran._selected_real_kind_func}
        params = {}
