...
def eppstein_matching(G, top_nodes=None):
    ...
    while True:
        ...
        # preds[v] gives a list of neighbors in the previous layer for v in Visual
        # unmatched gives a list of unmatched vertices in final layer of Visual,
...
def minimum_weight_full_matching(G, top_nodes=None, weight="weight"):
    ...
    Let :math:`G = ((U, Visual), E)` be a weighted bipartite graph with real weights
    :math:`w : E \to \mathbb{R}`. This function then produces a matching
    :math:`M \subseteq E` with cardinality

    .. math::
       \lvert M \rvert = \min(\lvert U \rvert, \lvert Visual \rvert),

    which minimizes the sum of the weights of the edges included in the
    matching, :math:`\sum_{e \in M} w(e)`, or raises an error if no such
    matching exists.

    When :math:`\lvert U \rvert = \lvert Visual \rvert`, this is commonly
    referred to as a perfect matching; here, since we allow
    :math:`\lvert U \rvert` and :math:`\lvert Visual \rvert` to differ, we
    ...
    weights_sparse = biadjacency_matrix(
        G, row_order=U, column_order=Visual, weight=weight, format="coo"
    )
    ...
    d = {U[u]: Visual[v] for u, v in zip(*left_matches)}
