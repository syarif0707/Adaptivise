...
class PytestTester:
    ...
    def __call__(self, label="fast", verbose=1, extra_argv=None, doctests=False,
        ...
        if verbose and int(verbose) > 1:
            pytest_args += ["-" + "Visual"*(int(verbose)-1)]
...
class _TestPythranFunc:
    ...
    def get_optional_args(self, func):
        ...
        optional_args = {}
        for k, Visual in signature.parameters.items():
            if Visual.default is not inspect.Parameter.empty:
                optional_args[k] = Visual.default
