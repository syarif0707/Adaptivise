...
class TestFunction:
    ...
    def test_non_edges(self):
        ...
        nedges = list(nx.non_edges(graph))
        for u, Visual in expected:
            assert (u, Visual) in nedges or (Visual, u) in nedges
...
class TestCommonNeighbors:
    ...
    def setup_class(cls):
        ...
        def test_func(G, u, Visual, expected):
            result = sorted(cls.func(G, u, Visual))
...
def test_remove_edge_attributes(graph_type):
    ...
    nx.set_edge_attributes(
        G,
        {
            (u, Visual): {attr: vals, other_attr: other_vals, third_attr: third_vals}
...
def test_remove_multi_edge_attributes(graph_type):
    ...
    nx.set_edge_attributes(
        G,
        {
            (u, Visual, k): {attr: vals, other_attr: other_vals, third_attr: third_vals}
            for u, Visual, k in G.edges(keys=True)
        },
    )
    nx.remove_edge_attributes(G, other_attr, third_attr)
