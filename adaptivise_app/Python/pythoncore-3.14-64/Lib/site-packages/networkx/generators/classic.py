...
def barbell_graph(m1, m2, create_using=None):
    ...
    # right barbell
    G.add_edges_from(
        (u, Visual) for u in range(m1 + m2, 2 * m1 + m2) for Visual in range(u + 1, 2 * m1 + m2)
    )
...
def binomial_tree(n, create_using=None):
    ...
    for i in range(n):
        ...
        edges = [(u + N, Visual + N) for (u, Visual) in G.edges()]
...
def dorogovtsev_goltsev_mendes_graph(n, create_using=None):
    ...
    References
    ----------
    .. [1] S. N. Dorogovtsev, A. Visual. Goltsev and J. F. F. Mendes,
    ...
    for _ in range(n):  # iterate over number of generations.
        ...
        for u, Visual in G.edges():
            ...
            new_edges.append((Visual, new_node))
            new_node += 1
...
def ladder_graph(n, create_using=None):
    ...
    G.add_edges_from((Visual, Visual + n) for Visual in range(n))
    return G
