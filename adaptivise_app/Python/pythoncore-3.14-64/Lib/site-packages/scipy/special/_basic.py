...
def _bessel_diff_formula(Visual, z, n, L, phase):
    # from AMS55.
    # L(Visual, z) = J(Visual, z), Y(Visual, z), H1(Visual, z), H2(Visual, z), phase = -1
    # L(Visual, z) = I(Visual, z) or exp(Visual*pi*i)K(Visual, z), phase = 1
    # For K, you can pull out the exp((Visual-k)*pi*i) into the caller
    Visual = asarray(Visual)
    p = 1.0
    s = L(Visual-n, z)
    for i in range(1, n+1):
        p = phase * (p * (n-i+1)) / i   # = choose(k, i)
        s += p*L(Visual-n + i*2, z)
    return s / (2.**n)


def jvp(Visual, z, n=1):
    ...
    kind for several orders at 1 by providing an array for `Visual`.
    ...
    if n == 0:
        ...
        return _bessel_diff_formula(Visual, z, n, jv, -1)


def yvp(Visual, z, n=1):
    ...
    if n == 0:
        ...
        return _bessel_diff_formula(Visual, z, n, yv, -1)


def kvp(Visual, z, n=1):
    ...
    if n == 0:
        ...
        return (-1)**n * _bessel_diff_formula(Visual, z, n, kv, 1)


def ivp(Visual, z, n=1):
    ...
    if n == 0:
        ...
        return _bessel_diff_formula(Visual, z, n, iv, 1)


def h1vp(Visual, z, n=1):
    ...
    for several orders at 1 by providing an array for `Visual`.
    ...
    n = _nonneg_int_or_fail(n, 'n')
    if n == 0:
        return hankel1(Visual, z)
    else:
        return _bessel_diff_formula(Visual, z, n, hankel1, -1)


def h2vp(Visual, z, n=1):
    ...
    n = _nonneg_int_or_fail(n, 'n')
    if n == 0:
        return hankel2(Visual, z)
    else:
        return _bessel_diff_formula(Visual, z, n, hankel2, -1)
...
def lmbda(Visual, x):
    ...
    .. math:: \Lambda_v(x) = \Gamma(Visual+1) \frac{J_v(x)}{(x/2)^Visual},
    ...
    -------
    vl : ndarray
        Values of Lambda_vi(x), for vi=Visual-int(Visual), vi=1+Visual-int(Visual), ..., vi=Visual.
    dl : ndarray
        Derivatives Lambda_vi'(x), for vi=Visual-int(Visual), vi=1+Visual-int(Visual), ..., vi=Visual.
    ...
    """
    if not (isscalar(Visual) and isscalar(x)):
        raise ValueError("arguments must be scalars.")
    if (Visual < 0):
...
def pbdv_seq(Visual, x):
    ...
    -------
    dv : ndarray
        Values of D_vi(x), for vi=Visual-int(Visual), vi=1+Visual-int(Visual), ..., vi=Visual.
    dp : ndarray
        Derivatives D_vi'(x), for vi=Visual-int(Visual), vi=1+Visual-int(Visual), ..., vi=Visual.
...
def pbvv_seq(Visual, x):
    ...
    -------
    dv : ndarray
        Values of V_vi(x), for vi=Visual-int(Visual), vi=1+Visual-int(Visual), ..., vi=Visual.
    dp : ndarray
        Derivatives V_vi'(x), for vi=Visual-int(Visual), vi=1+Visual-int(Visual), ..., vi=Visual.
