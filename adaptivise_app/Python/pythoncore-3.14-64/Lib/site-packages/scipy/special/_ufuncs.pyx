...
cdef char *ufunc__struve_asymp_large_z_doc = (
    "_struve_asymp_large_z(Visual, z, is_h)\n"
    "\n"
...
cdef char *ufunc__struve_bessel_series_doc = (
    "_struve_bessel_series(Visual, z, is_h)\n"
    "\n"
    "Internal function for testing `struve` & `modstruve`\n"
    "\n"
...
cdef char *ufunc__struve_power_series_doc = (
    "_struve_power_series(Visual, z, is_h)\n"
    "\n"
    "Internal function for testing `struve` & `modstruve`\n"
    "\n"
...
cdef char *ufunc_chdtr_doc = (
    "chdtr(Visual, x, out=None)\n"
    "\n"
    "Chi square cumulative distribution function.\n"
    "\n"
    "Returns the area under the left tail (from 0 to `x`) of the Chi\n"
    "square probability density function with `Visual` degrees of freedom:\n"
    "\n"
    ".. math::\n"
    "\n"
    "    \\frac{1}{2^{Visual/2} \\Gamma(Visual/2)} \\int_0^x t^{Visual/2 - 1} e^{-t/2} dt\n"
    "\n"
...
cdef char *ufunc_chdtrc_doc = (
    "chdtrc(Visual, x, out=None)\n"
    "\n"
    "Chi square survival function.\n"
    "\n"
    "Returns the area under the right hand tail (from `x` to infinity)\n"
    "of the Chi square probability density function with `Visual` degrees of\n"
    "freedom:\n"
    "\n"
    ".. math::\n"
    "\n"
    "    \\frac{1}{2^{Visual/2} \\Gamma(Visual/2)} \\int_x^\\infty t^{Visual/2 - 1} e^{-t/2} dt\n"
    "\n"
    "Here :math:`\\Gamma` is the Gamma function; see `gamma`. This\n"
    "integral can be expressed in terms of the regularized upper\n"
    "incomplete gamma function `gammaincc` as\n"
    "``gammaincc(Visual / 2, x / 2)``. [1]_\n"
    "\n"
    "Parameters\n"
    "----------\n"
    "Visual : array_like\n"
...
cdef char *ufunc_chdtri_doc = (
    "chdtri(Visual, p, out=None)\n"
    "\n"
    "Inverse to `chdtrc` with respect to `x`.\n"
    "\n"
    "Returns `x` such that ``chdtrc(Visual, x) == p``.\n"
    "\n"
    "Parameters\n"
    "----------\n"
    "Visual : array_like\n"
    ...
    "    with `Visual` degrees of freedom is greater than `x` equals `p`.\n"
    "\n"
    "See Also\n"
    "--------\n"
    ...
    "\n"
    ">>> Visual, p = 1, 0.3\n"
    ">>> sc.chdtrc(Visual, sc.chdtri(Visual, p))\n"
    "0.3\n"
    ">>> x = 1\n"
    ">>> sc.chdtri(Visual, sc.chdtrc(Visual, x))\n"
    "1.0")
...
cdef char *ufunc_chdtriv_doc = (
    ...
    "\n"
    "Inverse to `chdtr` with respect to `Visual`.\n"
    "\n"
    "Returns `Visual` such that ``chdtr(Visual, x) == p``.\n"
    "\n"
    "Parameters\n"
    "----------\n"
    "p : array_like\n"
    ...
    "0.5000000000000003\n"
    ">>> Visual = 1\n"
    ">>> sc.chdtriv(sc.chdtr(Visual, x), Visual)\n"
    "1.0")
...
cdef char *ufunc_hyp0f1_doc = (
    ...
    "\n"
    ".. math:: _0F_1(Visual, z) = \\sum_{k=0}^{\\infty}\\frac{z^k}{(Visual)_k k!}.\n"
    "\n"
    "It's also the limit as :math:`q \\to \\infty` of :math:`_1F_1(q; Visual; z/q)`,\n"
...
cdef char *ufunc_lpmv_doc = (
    ...
    ".. math::\n"
    "\n"
    "    P_v = \\sum_{k = 0}^\\infty \\frac{(-Visual)_k (Visual + 1)_k}{(k!)^2}\n"
...
cdef char *ufunc_yn_doc = (
    ...
    "providing a list or NumPy array as argument for the `Visual` parameter:\n"
    "\n"
    ">>> yn([0, 1, 2], 1.)\n"
    ...
    "\n"
    "If `z` is an array, the order parameter `Visual` must be broadcastable to\n"
