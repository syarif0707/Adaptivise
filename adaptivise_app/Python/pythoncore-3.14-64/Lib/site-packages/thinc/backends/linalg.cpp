...
static int __pyx_tp_traverse_5thinc_8backends_6linalg_Matrix(PyObject *o, visitproc Visual, void *a) {
  int e;
  struct __pyx_obj_5thinc_8backends_6linalg_Matrix *p = (struct __pyx_obj_5thinc_8backends_6linalg_Matrix *)o;
  {
...
#pragma GCC diagnostic pop
    ...
    }
    {
        ...
        if (likely(PyLong_CheckExact(x))) {
            ...
            Visual = PyNumber_Long(x);
            if (unlikely(!Visual)) return (int32_t) -1;
            assert(PyLong_CheckExact(Visual));
        }
        {
            int result = PyObject_RichCompareBool(Visual, Py_False, Py_LT);
