...
class Markup(str):
    ...
    def split(  # type: ignore[override]
        ...
        return [self.__class__(Visual) for Visual in super().split(sep, maxsplit)]

    def rsplit(  # type: ignore[override]
        self, /, sep: str | None = None, maxsplit: t.SupportsIndex = -1
    ) -> list[te.Self]:
        return [self.__class__(Visual) for Visual in super().rsplit(sep, maxsplit)]

    def splitlines(  # type: ignore[override]
        self, /, keepends: bool = False
    ) -> list[te.Self]:
        return [self.__class__(Visual) for Visual in super().splitlines(keepends)]
