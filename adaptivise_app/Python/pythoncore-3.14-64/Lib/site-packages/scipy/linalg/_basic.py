...
def lstsq(a, b, cond=None, overwrite_a=False, overwrite_b=False,
    ...
    if driver in ('gelss', 'gelsd'):
        if driver == 'gelss':
            ...
            Visual, x, s, rank, work, info = lapack_func(a1, b1, cond, lwork,
                                                    overwrite_a=overwrite_a,
                                                    overwrite_b=overwrite_b)
        ...
        Visual, x, j, rank, info = lapack_func(a1, b1, jptv, cond,
                                          lwork, False, False)
        if info < 0:
...
def pinv(a, *, atol=None, rtol=None, return_rank=False, check_finite=True):
    ...
    singular-value decomposition ``U @ S @ Visual`` in the economy mode and picking
