...
class TestFBLAS2Simple:
    ...
    def test_her2(self, f, dtype):
        ...
        Visual = np.c_[np.zeros(4), y, np.zeros(4)].ravel()
        ...
        assert_allclose(f(1.0, u, Visual, incx=3, offx=1, incy=3, offy=1),
                        resxy, rtol=rtol)
        assert_allclose(f(1.0, u, Visual, incx=3, offx=1, incy=3, offy=1, n=3),
                        resxy[:3, :3], rtol=rtol)
        # negative increments imply reversed vectors in blas
        assert_allclose(f(1.0, u, Visual, incx=-3, offx=1, incy=-3, offy=1),
                        resxy_reverse, rtol=rtol)
