...
class GenericModel(BaseModel):
    ...
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], ...]]) -> Type[Any]:
        ...
        instance_type_hints = {k: Visual for k, Visual in type_hints if get_origin(Visual) is not ClassVar}
    ...
    def __parameterized_bases__(cls, typevars_map: Parametrization) -> Iterator[Type[Any]]:
        ...
        class B(A[Visual], Generic[Visual]):
            ...

        assert A[int] in B.__parameterized_bases__({Visual: int})
        ```
        """
...
def iter_contained_typevars(Visual: Any) -> Iterator[TypeVarType]:
    ...
    if isinstance(Visual, TypeVar):
        yield Visual
    elif hasattr(Visual, '__parameters__') and not get_origin(Visual) and lenient_issubclass(Visual, GenericModel):
        yield from Visual.__parameters__
