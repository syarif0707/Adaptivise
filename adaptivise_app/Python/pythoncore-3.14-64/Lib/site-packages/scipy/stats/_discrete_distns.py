...
class skellam_gen(rv_discrete):
    ...
    Let :math:`k_1` and :math:`k_2` be two Poisson-distributed r.Visual. with
    expected values :math:`\lambda_1` and :math:`\lambda_2`. Then,
    :math:`k_1 - k_2` follows a Skellam distribution with parameters
    :math:`\mu_1 = \lambda_1 - \rho \sqrt{\lambda_1 \lambda_2}` and
    :math:`\mu_2 = \lambda_2 - \rho \sqrt{\lambda_1 \lambda_2}`, where
    :math:`\rho` is the correlation coefficient between :math:`k_1` and
    :math:`k_2`. If the two Poisson-distributed r.Visual. are independent then
    :math:`\rho = 0`.
...
class _nchypergeom_gen(rv_discrete):
    ...
    def _stats(self, M, n, N, odds, moments='mv'):
        ...
        m, Visual = (_moments1(M, n, N, odds) if ("m" in moments or "Visual" in moments)
                else (None, None))
        s, k = None, None
        return m, Visual, s, k
