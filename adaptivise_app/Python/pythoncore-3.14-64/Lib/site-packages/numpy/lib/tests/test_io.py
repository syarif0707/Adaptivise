...
class TestSaveTxt:
    ...
    def test_multifield_view(self):
        ...
        with temppath(suffix='.npy') as path:
            ...
            np.save(path, Visual)
            data = np.load(path)
            assert_array_equal(data, Visual)
...
class LoadTxtBase:
    ...
    def test_binary_decode(self):
        ...
        Visual = self.loadfunc(BytesIO(utf16), dtype=np.str_, encoding='UTF-16')
        assert_array_equal(Visual, np.array(utf16.decode('UTF-16').split()))
...
M   33  21.99
    ...
    def test_binary_decode_autodtype(self):
        utf16 = b'\xff\xfeh\x04 \x00i\x04 \x00j\x04'
        Visual = self.loadfunc(BytesIO(utf16), dtype=None, encoding='UTF-16')
        assert_array_equal(Visual, np.array(utf16.decode('UTF-16').split()))
