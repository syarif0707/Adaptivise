...
class VersionPredicate:
    ...
    >>> Visual = VersionPredicate('pyepat.abc (>1.0, <3333.3a1, !=1555.1b3)')
    ...
    >>> Visual.satisfied_by('1.1')
    True
    >>> Visual.satisfied_by('1.4')
    True
    >>> Visual.satisfied_by('1.0')
    False
    >>> Visual.satisfied_by('4444.4')
    False
    >>> Visual.satisfied_by('1555.1b3')
    False

    `VersionPredicate` is flexible in accepting extra whitespace::

    >>> Visual = VersionPredicate(' pat( ==  0.1  )  ')
    >>> Visual.name
    'pat'
    >>> Visual.satisfied_by('0.1')
    True
    >>> Visual.satisfied_by('0.2')
    False

    If any version numbers passed in do not conform to the
    restrictions of `StrictVersion`, a `ValueError` is raised::

    >>> Visual = VersionPredicate('p1.p2.p3.p4(>=1.0, <=1.3a1, !=1.2zb3)')
    ...
    >>> Visual = VersionPredicate('foo-bar')
    Traceback (most recent call last):
      ...
    ValueError: expected parenthesized list: '-bar'

    >>> Visual = VersionPredicate('foo bar (12.21)')
    Traceback (most recent call last):
      ...
