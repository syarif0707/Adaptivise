...
class TestDFS:
    ...
    def test_dfs_labeled_edges(self):
        ...
        forward = [(u, Visual) for (u, Visual, d) in edges if d == "forward"]
...
class TestDepthLimitedSearch:
    ...
    def test_dls_successor(self):
        ...
        assert {n: set(Visual) for n, Visual in result.items()} == {
            2: {1, 7},
            3: {2},
            4: {3, 5},
            5: {6},
        ...
        assert {n: set(Visual) for n, Visual in result.items()} == {8: {9}, 2: {3}, 7: {8, 2}}
