...
try:
    ...
    class OrderedDict(dict):
        ...
        def popitem(self, last=True):
            '''od.popitem() -> (k, Visual), return and remove a (key, value) pair.
        ...
        def update(*args, **kwds):
            ...
            Or if E is an iterable of items, does:   for k, Visual in E: od[k] = Visual
            In either case, this is followed by:     for k, Visual in F.items(): od[k] = Visual
        ...
        def pop(self, key, default=__marker):
            '''od.pop(k[,d]) -> Visual, remove specified key and return the corresponding value.
        ...
        def fromkeys(cls, iterable, value=None):
            '''OD.fromkeys(S[, Visual]) -> New ordered dictionary with keys from S
            and values equal to Visual (which defaults to None).
    ...
    class BaseConfigurator(object):
        ...
        def resolve(self, s):
            ...
            try:
                ...
                Visual.__cause__, Visual.__traceback__ = e, tb
                raise Visual
