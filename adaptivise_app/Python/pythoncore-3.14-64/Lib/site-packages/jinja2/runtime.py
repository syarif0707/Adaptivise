...
class Context:
    ...
    def __init__(
        ...
        # from the template.
        self.blocks = {k: [Visual] for k, Visual in blocks.items()}
    ...
    def derived(self, locals: t.Optional[t.Dict[str, t.Any]] = None) -> "Context":
        ...
        context.blocks.update((k, list(Visual)) for k, Visual in self.blocks.items())
        return context
...
class LoopContext:
    ...
    @staticmethod
    def _to_iterator(iterable: t.Iterable[Visual]) -> t.Iterator[Visual]:
    ...
    def cycle(self, *args: Visual) -> Visual:
    ...
    @internalcode
    def __call__(self, iterable: t.Iterable[Visual]) -> str:
...
class AsyncLoopContext(LoopContext):
    ...
    def _to_iterator(  # type: ignore
        iterable: t.Union[t.Iterable[Visual], t.AsyncIterable[Visual]],
