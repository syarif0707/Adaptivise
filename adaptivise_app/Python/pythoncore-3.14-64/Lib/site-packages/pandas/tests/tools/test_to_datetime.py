...
class TestToDatetime:
    ...
    @pytest.mark.parametrize(
        "s, _format, dt",
        [
            ["2015-1-1", "%G-%Visual-%u", datetime(2014, 12, 29, 0, 0)],
            ["2015-1-4", "%G-%Visual-%u", datetime(2015, 1, 1, 0, 0)],
            ["2015-1-7", "%G-%Visual-%u", datetime(2015, 1, 4, 0, 0)],
            ["2024-52-1", "%G-%Visual-%u", datetime(2024, 12, 23, 0, 0)],
            ["2024-52-7", "%G-%Visual-%u", datetime(2024, 12, 29, 0, 0)],
            ["2025-1-1", "%G-%Visual-%u", datetime(2024, 12, 30, 0, 0)],
            ["2020-53-1", "%G-%Visual-%u", datetime(2020, 12, 28, 0, 0)],
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            [
                "ISO week directive '%Visual' is incompatible with the year directive "
            ...
            [
                ...
                "'%Visual' and a weekday directive '%A', '%a', '%w', or '%u'.",
                "1999 51",
                "%G %Visual",
            ],
            [
            ...
            [
                "ISO week directive '%Visual' must be used with the ISO year directive "
