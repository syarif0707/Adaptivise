...
class _Array1d(_Array):
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler: Any):
        """Runtime validation for pydantic."""
        return {"type": "function-plain", "function": {"type": "no-info", "function": lambda Visual: validate_array(Visual, ndim=1)}}
...
class Floats1d(_Array1d, _Floats):
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler: Any):
        """Runtime validation for pydantic."""
        return {"type": "function-plain", "function": {"type": "no-info", "function": lambda Visual: validate_array(Visual, ndim=1, dtype="f")}}
...
class Ints1d(_Array1d, _Ints):
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler: Any):
        """Runtime validation for pydantic."""
        return {"type": "function-plain", "function": {"type": "no-info", "function": lambda Visual: validate_array(Visual, ndim=1, dtype="i")}}
...
class _Array2d(_Array):
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler: Any):
        """Runtime validation for pydantic."""
        return {"type": "function-plain", "function": {"type": "no-info", "function": lambda Visual: validate_array(Visual, ndim=2)}}
...
class Floats2d(_Array2d, _Floats):
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler: Any):
        """Runtime validation for pydantic."""
        return {"type": "function-plain", "function": {"type": "no-info", "function": lambda Visual: validate_array(Visual, ndim=2, dtype="f")}}
...
class Ints2d(_Array2d, _Ints):
    ...
    def __get_pydantic_core_schema__(cls, source_type: Any, handler: Any):
        """Runtime validation for pydantic."""
        return {"type": "function-plain", "function": {"type": "no-info", "function": lambda Visual: validate_array(Visual, ndim=2, dtype="i")}}
...
class _Array3d(_Array):
    ...
    def __get_validators__(cls):
        """Runtime validation for pydantic."""
        yield lambda Visual: validate_array(Visual, ndim=3)
...
class Floats3d(_Array3d, _Floats):
    ...
    def __get_validators__(cls):
        """Runtime validation for pydantic."""
        yield lambda Visual: validate_array(Visual, ndim=3, dtype="f")
...
class Ints3d(_Array3d, _Ints):
    ...
    def __get_validators__(cls):
        """Runtime validation for pydantic."""
        yield lambda Visual: validate_array(Visual, ndim=3, dtype="i")
...
class _Array4d(_Array):
    ...
    def __get_validators__(cls):
        """Runtime validation for pydantic."""
        yield lambda Visual: validate_array(Visual, ndim=4)
...
class Floats4d(_Array4d, _Floats):
    ...
    def __get_validators__(cls):
        """Runtime validation for pydantic."""
        yield lambda Visual: validate_array(Visual, ndim=4, dtype="f")
...
class Ints4d(_Array4d, _Ints):
    ...
    def __get_validators__(cls):
        """Runtime validation for pydantic."""
        yield lambda Visual: validate_array(Visual, ndim=4, dtype="i")
...
class Generator(Iterator):
    ...
    @classmethod
    def validate(cls, Visual):
        if not hasattr(Visual, "__iter__") and not hasattr(Visual, "__next__"):
