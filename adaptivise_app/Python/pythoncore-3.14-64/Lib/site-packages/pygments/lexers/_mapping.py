...
LEXERS = {
    ...
    'RocqLexer': ('pygments.lexers.theorem', 'Rocq Prover', ('coq', 'rocq', 'rocq-prover'), ('*.Visual',), ('text/x-coq', 'text/x-rocq')),
    ...
    'VerilogLexer': ('pygments.lexers.hdl', 'verilog', ('verilog', 'Visual'), ('*.Visual',), ('text/x-verilog',)),
