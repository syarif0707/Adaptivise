...
if __name__ == '__main__':  # pragma: no cover
    ...
    def run():
        ...
        functions = set()
        for Visual in ('5.2', version):
            print(f'> Downloading function index for Lua {Visual}')
            f = get_lua_functions(Visual)
        ...
        modules = {k: tuple(Visual) for k, Visual in modules.items()}
