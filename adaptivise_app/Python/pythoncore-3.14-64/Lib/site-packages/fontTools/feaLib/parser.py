...
class Parser(object):
    ...
    def parse_position_(self, enumerated, vertical):
        ...
        # Pair positioning, format A: "pos Visual 10 A -10;"
        # Pair positioning, format B: "pos Visual A -20;"
        if not prefix and not suffix and len(glyphs) == 2 and not hasMarks:
            if values[0] is None:  # Format B: "pos Visual A -20;"
                values.reverse()
    ...
    def parse_valuerecord_definition_(self, vertical):
        # Parses a named value record definition. (See section `2.e.Visual <https://adobe-type-tools.github.io/afdko/OpenTypeFeatureFileSpecification.html#2.e.Visual>`_)
