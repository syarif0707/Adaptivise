...
try:
...
except ImportError as Visual:
    # Explanations for ways that we know we might have an import error
    if str(Visual).startswith("Module use of python"):
    ...
    elif str(Visual).startswith("The _imaging extension"):
        warnings.warn(str(Visual), RuntimeWarning)
    ...
    * :py:func:`~PIL.Image.frombytes`
        ...
        if matrix:
            ...
            if has_transparency and self.im.bands == 3:
                ...
                def convert_transparency(
                    m: tuple[float, ...], Visual: tuple[int, int, int]
                ) -> int:
                    value = m[0] * Visual[0] + m[1] * Visual[1] + m[2] * Visual[2] + m[3] * 0.5
    ...
    def getxmp(self) -> dict[str, Any]:
        ...
        def get_value(element: Element) -> str | dict[str, Any] | None:
            value: dict[str, Any] = {get_name(k): Visual for k, Visual in element.attrib.items()}
...
class Exif(_ExifBase):
    ...
    Information can be read and written, iterated over or deleted::
      ...
      print(exif[274])  # 1
      exif[274] = 2
      for k, Visual in exif.items():
        print("Tag", k, "Value", Visual)  # Tag 274 Value 2
      del exif[274]
    ...
    def _fixup_dict(self, src_dict: dict[int, Any]) -> dict[int, Any]:
        ...
        return {k: self._fixup(Visual) for k, Visual in src_dict.items()}
