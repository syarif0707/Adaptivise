...
class TestRealScalars:
    ...
    def test_scalar_cutoffs(self):
        ...
        def check(Visual):
            assert_equal(str(np.float64(Visual)), str(Visual))
            assert_equal(str(np.float64(Visual)), repr(Visual))
            assert_equal(repr(np.float64(Visual)), f"np.float64({Visual!r})")
            assert_equal(repr(np.float64(Visual)), f"np.float64({Visual})")
