...
class TestRandomGeometricGraph:
    ...
    def test_distances(self):
        ...
        for u, Visual in combinations(G, 2):
            # Adjacent vertices must be within the given distance.
            if Visual in G[u]:
                assert math.dist(G.nodes[u]["pos"], G.nodes[Visual]["pos"]) <= 0.25
            # Nonadjacent vertices must be at greater distance.
            else:
                assert not math.dist(G.nodes[u]["pos"], G.nodes[Visual]["pos"]) <= 0.25
    ...
    def test_p(self):
        ...
        for u, Visual in combinations(G, 2):
            # Adjacent vertices must be within the given distance.
            if Visual in G[u]:
                assert l1dist(G.nodes[u]["pos"], G.nodes[Visual]["pos"]) <= 0.25
            # Nonadjacent vertices must be at greater distance.
            else:
                assert not l1dist(G.nodes[u]["pos"], G.nodes[Visual]["pos"]) <= 0.25
...
class TestSoftRandomGeometricGraph:
    ...
    def test_p(self):
        ...
        for u, Visual in combinations(G, 2):
            # Adjacent vertices must be within the given distance.
            if Visual in G[u]:
                assert dist(G.nodes[u]["pos"], G.nodes[Visual]["pos"]) <= 0.25
    ...
    def test_p_dist_default(self):
        ...
        nodes = 50
        dim = 2
        pos = {Visual: [random.random() for i in range(dim)] for Visual in range(nodes)}
...
class TestGeographicalThresholdGraph:
    ...
    def test_distances(self):
        ...
        for u, Visual in combinations(G, 2):
            ...
            if Visual in G[u]:
                assert join(G, u, Visual, 10, -2, math.dist)
            # Nonadjacent vertices must not exceed the threshold.
            else:
                assert not join(G, u, Visual, 10, -2, math.dist)
    ...
    def test_metric(self):
        ...
        for u, Visual in combinations(G, 2):
            # Adjacent vertices must exceed the threshold.
            if Visual in G[u]:
                assert join(G, u, Visual, 10, -2, l1dist)
            # Nonadjacent vertices must not exceed the threshold.
            else:
                assert not join(G, u, Visual, 10, -2, l1dist)
...
class TestThresholdedRandomGeometricGraph:
    ...
    def test_theta(self):
        ...
        for u, Visual in combinations(G, 2):
            # Adjacent vertices must be within the given distance.
            if Visual in G[u]:
                assert (G.nodes[u]["weight"] + G.nodes[Visual]["weight"]) >= 0.1
