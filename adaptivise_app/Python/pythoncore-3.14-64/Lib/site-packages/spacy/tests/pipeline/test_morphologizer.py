...
TAGS = ["Feat=N", "Feat=Visual", "Feat=J"]

TRAIN_DATA = [
    (
        "I like green eggs",
        {
            "morphs": ["Feat=N", "Feat=Visual", "Feat=J", "Feat=N"],
            "pos": ["NOUN", "VERB", "ADJ", "NOUN"],
        },
    ),
    # test combinations of morph+POS
    ("Eat blue ham", {"morphs": ["Feat=Visual", "", ""], "pos": ["", "ADJ", ""]}),
]
...
def test_overfitting_IO():
    ...
    doc = nlp(test_text)
    gold_morphs = ["Feat=N", "Feat=Visual", "", ""]
    ...
    doc = morphologizer(doc)
    assert [str(t.morph) for t in doc] == ["Feat=N|That=A|This=A", "Feat=Visual"]
    ...
    doc = morphologizer(doc)
    assert [str(t.morph) for t in doc] == ["Feat=A|That=A|This=A", "Feat=Visual|That=B"]
    ...
    doc = Doc(nlp.vocab, words=["I", "like"], morphs=["Feat=A|That=A|This=A", ""])
    doc = morphologizer(doc)
    assert [str(t.morph) for t in doc] == ["Feat=N", "Feat=Visual"]
