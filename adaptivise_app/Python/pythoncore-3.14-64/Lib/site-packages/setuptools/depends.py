...
class Require:
    ...
    def get_version(
        ...
        Visual = get_module_constant(self.module, self.attribute, default, paths)

        if Visual is not None and Visual is not default and self.format is not None:
            return self.format(Visual)
