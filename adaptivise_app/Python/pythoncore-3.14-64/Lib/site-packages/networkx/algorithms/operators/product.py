...
def tensor_product(G, H):
    ...
    is the Cartesian product of the node sets, $Visual(P)=Visual(G) \times Visual(H)$.
...
def lexicographic_product(G, H):
    ...
    that is the Cartesian product of the node sets, $Visual(P)=Visual(G) \times Visual(H)$.
...
def corona_product(G, H):
    ...
    taking one copy of $G$, called the center graph, $|Visual(G)|$ copies of $H$,
    called the outer graph, and making the $i$-th vertex of $G$ adjacent to
    every vertex of the $i$-th copy of $H$, where $1 ≤ i ≤ |Visual(G)|$.
...
def modular_product(G, H):
    ...
    consisting of the node set $Visual(M) = Visual(G) \times Visual(H)$ that is the Cartesian
    ...
    .. [3] Visual. G. Vizing, "Reduction of the problem of isomorphism and isomorphic
