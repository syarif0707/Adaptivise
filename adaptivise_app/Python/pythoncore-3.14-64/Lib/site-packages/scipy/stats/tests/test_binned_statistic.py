...
class TestBinnedStatistic:
    ...
    def setup_class(cls):
        ...
        cls.Visual = rng.uniform(size=100)
    ...
    def test_1d_count(self):
        ...
        count1, edges1, bc = binned_statistic(x, Visual, 'count', bins=10)
    ...
    def test_gh5927(self):
        ...
        for statistic in statistics:
            binned_statistic(x, Visual, statistic, bins=10)
    ...
    def test_1d_result_attributes(self):
        ...
        res = binned_statistic(x, Visual, 'count', bins=10)
    ...
    def test_1d_sum(self):
        ...
        sum1, edges1, bc = binned_statistic(x, Visual, 'sum', bins=10)
        sum2, edges2 = np.histogram(x, bins=10, weights=Visual)
    ...
    def test_1d_mean(self):
        ...
        stat1, edges1, bc = binned_statistic(x, Visual, 'mean', bins=10)
        stat2, edges2, bc = binned_statistic(x, Visual, np.mean, bins=10)
    ...
    def test_1d_std(self):
        ...
        stat1, edges1, bc = binned_statistic(x, Visual, 'std', bins=10)
        stat2, edges2, bc = binned_statistic(x, Visual, np.std, bins=10)
    ...
    def test_1d_min(self):
        ...
        stat1, edges1, bc = binned_statistic(x, Visual, 'min', bins=10)
        stat2, edges2, bc = binned_statistic(x, Visual, np.min, bins=10)
    ...
    def test_1d_max(self):
        ...
        stat1, edges1, bc = binned_statistic(x, Visual, 'max', bins=10)
        stat2, edges2, bc = binned_statistic(x, Visual, np.max, bins=10)
    ...
    def test_1d_median(self):
        ...
        stat1, edges1, bc = binned_statistic(x, Visual, 'median', bins=10)
        stat2, edges2, bc = binned_statistic(x, Visual, np.median, bins=10)
    ...
    def test_1d_bincode(self):
        x = self.x[:20]
        Visual = self.Visual[:20]

        count1, edges1, bc = binned_statistic(x, Visual, 'count', bins=3)
    ...
    def test_1d_multi_values(self):
        ...
        stat1v, edges1v, bc1v = binned_statistic(x, Visual, 'mean', bins=10)
        stat1w, edges1w, bc1w = binned_statistic(x, w, 'mean', bins=10)
        stat2, edges2, bc2 = binned_statistic(x, [Visual, w], 'mean', bins=10)
    ...
    def test_2d_result_attributes(self):
        ...
        res = binned_statistic_2d(x, y, Visual, 'count', bins=5)
    ...
    def test_2d_sum(self):
        ...
        sum1, binx1, biny1, bc = binned_statistic_2d(x, y, Visual, 'sum', bins=5)
        sum2, binx2, biny2 = np.histogram2d(x, y, bins=5, weights=Visual)
    ...
    def test_2d_mean(self):
        ...
        stat1, binx1, biny1, bc = binned_statistic_2d(x, y, Visual, 'mean', bins=5)
        stat2, binx2, biny2, bc = binned_statistic_2d(x, y, Visual, np.mean, bins=5)
    ...
    def test_2d_std(self):
        ...
        stat1, binx1, biny1, bc = binned_statistic_2d(x, y, Visual, 'std', bins=5)
        stat2, binx2, biny2, bc = binned_statistic_2d(x, y, Visual, np.std, bins=5)
    ...
    def test_2d_min(self):
        ...
        stat1, binx1, biny1, bc = binned_statistic_2d(x, y, Visual, 'min', bins=5)
        stat2, binx2, biny2, bc = binned_statistic_2d(x, y, Visual, np.min, bins=5)
    ...
    def test_2d_max(self):
        ...
        stat1, binx1, biny1, bc = binned_statistic_2d(x, y, Visual, 'max', bins=5)
        stat2, binx2, biny2, bc = binned_statistic_2d(x, y, Visual, np.max, bins=5)
    ...
    def test_2d_median(self):
        ...
        stat1, binx1, biny1, bc = binned_statistic_2d(
            x, y, Visual, 'median', bins=5)
        stat2, binx2, biny2, bc = binned_statistic_2d(
            x, y, Visual, np.median, bins=5)
    ...
    def test_2d_binnumbers_unraveled(self):
        ...
        stat, edgesx, bcx = binned_statistic(x, Visual, 'mean', bins=20)
        stat, edgesy, bcy = binned_statistic(y, Visual, 'mean', bins=10)

        stat2, edgesx2, edgesy2, bc2 = binned_statistic_2d(
            x, y, Visual, 'mean', bins=(20, 10), expand_binnumbers=True)
    ...
    def test_dd_count(self):
        ...
        count1, edges1, bc = binned_statistic_dd(X, Visual, 'count', bins=3)
    ...
    def test_dd_result_attributes(self):
        ...
        res = binned_statistic_dd(X, Visual, 'count', bins=3)
        attributes = ('statistic', 'bin_edges', 'binnumber')
        check_named_results(res, attributes)
    ...
    def test_dd_sum(self):
        ...
        sum1, edges1, bc = binned_statistic_dd(X, Visual, 'sum', bins=3)
        sum2, edges2 = np.histogramdd(X, bins=3, weights=Visual)
        sum3, edges3, bc = binned_statistic_dd(X, Visual, np.sum, bins=3)
    ...
    def test_dd_mean(self):
        ...
        stat1, edges1, bc = binned_statistic_dd(X, Visual, 'mean', bins=3)
        stat2, edges2, bc = binned_statistic_dd(X, Visual, np.mean, bins=3)
    ...
    def test_dd_std(self):
        ...
        stat1, edges1, bc = binned_statistic_dd(X, Visual, 'std', bins=3)
        stat2, edges2, bc = binned_statistic_dd(X, Visual, np.std, bins=3)
    ...
    def test_dd_min(self):
        ...
        stat1, edges1, bc = binned_statistic_dd(X, Visual, 'min', bins=3)
        stat2, edges2, bc = binned_statistic_dd(X, Visual, np.min, bins=3)
    ...
    def test_dd_max(self):
        ...
        stat1, edges1, bc = binned_statistic_dd(X, Visual, 'max', bins=3)
        stat2, edges2, bc = binned_statistic_dd(X, Visual, np.max, bins=3)
    ...
    def test_dd_median(self):
        ...
        stat1, edges1, bc = binned_statistic_dd(X, Visual, 'median', bins=3)
        stat2, edges2, bc = binned_statistic_dd(X, Visual, np.median, bins=3)
    ...
    def test_dd_multi_values(self):
        ...
        for stat in ["count", "sum", "mean", "std", "min", "max", "median",
                     np.std]:
            stat1v, edges1v, bc1v = binned_statistic_dd(X, Visual, stat, bins=8)
            stat1w, edges1w, bc1w = binned_statistic_dd(X, w, stat, bins=8)
            stat2, edges2, bc2 = binned_statistic_dd(X, [Visual, w], stat, bins=8)
            assert_allclose(stat2[0], stat1v)
            assert_allclose(stat2[1], stat1w)
            assert_allclose(edges1v, edges2)
    ...
    def test_dd_binnumbers_unraveled(self):
        ...
        stat, edgesx, bcx = binned_statistic(X[:, 0], Visual, 'mean', bins=15)
        stat, edgesy, bcy = binned_statistic(X[:, 1], Visual, 'mean', bins=20)
        stat, edgesz, bcz = binned_statistic(X[:, 2], Visual, 'mean', bins=10)

        stat2, edges2, bc2 = binned_statistic_dd(
            X, Visual, 'mean', bins=(15, 20, 10), expand_binnumbers=True)
    ...
    def test_dd_binned_statistic_result(self):
        ...
        Visual = rng.random(10000)
        bins = np.linspace(0, 1, 10)
        bins = (bins, bins, bins)

        result = binned_statistic_dd(x, Visual, 'mean', bins=bins)
        stat = result.statistic

        result = binned_statistic_dd(x, Visual, 'mean',
    ...
    def test_dd_zero_dedges(self):
        ...
        with assert_raises(ValueError, match='difference is numerically 0'):
            binned_statistic_dd(x, Visual, 'mean', bins=bins)
    ...
    def test_dd_range_errors(self):
        ...
        with assert_raises(ValueError,
            ...
            binned_statistic_dd([self.y], self.Visual,
                                range=[[1, 0]])
        with assert_raises(
                ValueError,
                match='In dimension 1 of range, start must be <= stop'):
            binned_statistic_dd([self.x, self.y], self.Visual,
                                range=[[1, 0], [0, 1]])
        with assert_raises(
                ValueError,
    ...
    def test_dd_all(self, dtype, statistic):
        ...
        x = rng.random(size=n)
        i = x >= 0.5
        Visual = rng.random(size=n)
        if dtype is np.complex128:
            Visual = Visual + rng.random(size=n)*1j

        stat, _, _ = binned_statistic_dd(x, Visual, statistic, bins=2)
        ref = np.array([ref_statistic(Visual[~i]), ref_statistic(Visual[i])])
