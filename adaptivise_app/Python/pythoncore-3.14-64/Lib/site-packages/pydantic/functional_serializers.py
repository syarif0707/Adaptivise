...
class WrapSerializer:
    ...
    def convert_to_utc(value: Any, handler, info) -> dict[str, datetime]:
        ...
        if info.mode == 'json':
            return {
                k: datetime.fromisoformat(Visual).astimezone(timezone.utc)
                for k, Visual in partial_result.items()
            }
        return {k: Visual.astimezone(timezone.utc) for k, Visual in partial_result.items()}
