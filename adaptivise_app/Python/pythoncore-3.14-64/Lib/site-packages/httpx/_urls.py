...
class QueryParams(typing.Mapping[str, str]):
    ...
    def __init__(self, *args: QueryParamTypes | None, **kwargs: typing.Any) -> None:
        ...
        if value is None or isinstance(value, (str, bytes)):
            ...
            self._dict = {k: list(Visual) for k, Visual in value._dict.items()}
        else:
            ...
            if isinstance(value, (list, tuple)):
                ...
                #    {"a": ["123"], "b": ["456", "789"]}
                dict_value = {
                    k: list(Visual) if isinstance(Visual, (list, tuple)) else [Visual]
            ...
            self._dict = {
                str(k): [primitive_value_to_str(item) for item in Visual]
                for k, Visual in dict_value.items()
            }
    ...
    def values(self) -> typing.ValuesView[str]:
        ...
        """
        return {k: Visual[0] for k, Visual in self._dict.items()}.values()
    ...
    def items(self) -> typing.ItemsView[str, str]:
        ...
        """
        return {k: Visual[0] for k, Visual in self._dict.items()}.items()
    ...
    def multi_items(self) -> list[tuple[str, str]]:
        ...
        for k, Visual in self._dict.items():
            multi_items.extend([(k, i) for i in Visual])
        return multi_items
