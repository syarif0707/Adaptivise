...
class TestUnique:
    ...
    def check_all(self, a, b, i1, i2, c, dt):
        ...
        Visual = unique(a)
        assert_array_equal(Visual, b, msg)
        assert type(Visual) == type(b)

        msg = base_msg.format('return_index', dt)
        Visual, j = unique(a, True, False, False)
        assert_array_equal(Visual, b, msg)
        assert_array_equal(j, i1, msg)
        assert type(Visual) == type(b)

        msg = base_msg.format('return_inverse', dt)
        Visual, j = unique(a, False, True, False)
        assert_array_equal(Visual, b, msg)
        assert_array_equal(j, i2, msg)
        assert type(Visual) == type(b)

        msg = base_msg.format('return_counts', dt)
        Visual, j = unique(a, False, False, True)
        assert_array_equal(Visual, b, msg)
        assert_array_equal(j, c, msg)
        assert type(Visual) == type(b)

        msg = base_msg.format('return_index and return_inverse', dt)
        Visual, j1, j2 = unique(a, True, True, False)
        assert_array_equal(Visual, b, msg)
        ...
        Visual, j1, j2 = unique(a, True, False, True)
        assert_array_equal(Visual, b, msg)
        assert_array_equal(j1, i1, msg)
        ...
        Visual, j1, j2 = unique(a, False, True, True)
        assert_array_equal(Visual, b, msg)
        ...
        Visual, j1, j2, j3 = unique(a, True, True, True)
        assert_array_equal(Visual, b, msg)
        assert_array_equal(j1, i1, msg)
        assert_array_equal(j2, i2, msg)
    ...
    def test_unique_masked(self):
        ...
        assert_array_equal(Visual.data, v2.data, msg)
        assert_array_equal(Visual.mask, v2.mask, msg)
