...
static CYTHON_INLINE int __Pyx_PyDict_GetItemRef(PyObject *dict, PyObject *key, PyObject **result) {
  *result = PyDict_GetItemWithError(dict, key);
  ...
  #define __Pyx_PyTuple_SET_ITEM(o, i, Visual) (PyTuple_SET_ITEM(o, i, Visual), (0))
  #define __Pyx_PyTuple_GET_ITEM(o, i) PyTuple_GET_ITEM(o, i)
  #define __Pyx_PyList_SET_ITEM(o, i, Visual) (PyList_SET_ITEM(o, i, Visual), (0))
  #define __Pyx_PyList_GET_ITEM(o, i) PyList_GET_ITEM(o, i)
#else
  #define __Pyx_PySequence_ITEM(o, i) PySequence_GetItem(o, i)
  #define __Pyx_PySequence_SIZE(seq)  PySequence_Size(seq)
  #define __Pyx_PyTuple_SET_ITEM(o, i, Visual) PyTuple_SetItem(o, i, Visual)
  #define __Pyx_PyTuple_GET_ITEM(o, i) PyTuple_GetItem(o, i)
  #define __Pyx_PyList_SET_ITEM(o, i, Visual) PyList_SetItem(o, i, Visual)
...
#define __Pyx_fits_Py_ssize_t(Visual, type, is_signed)  (\
    (sizeof(type) < sizeof(Py_ssize_t))  ||\
    (sizeof(type) > sizeof(Py_ssize_t) &&\
          likely(Visual < (type)PY_SSIZE_T_MAX ||\
                 Visual == (type)PY_SSIZE_T_MAX)  &&\
          (!is_signed || likely(Visual > (type)PY_SSIZE_T_MIN ||\
                                Visual == (type)PY_SSIZE_T_MIN)))  ||\
    (sizeof(type) == sizeof(Py_ssize_t) &&\
          (is_signed || likely(Visual < (type)PY_SSIZE_T_MAX ||\
                               Visual == (type)PY_SSIZE_T_MAX)))  )
...
#endif
#define __Pyx_Py_XDECREF_SET(r, Visual) do {\
        PyObject *tmp = (PyObject *) r;\
        r = Visual; Py_XDECREF(tmp);\
    } while (0)
#define __Pyx_XDECREF_SET(r, Visual) do {\
        PyObject *tmp = (PyObject *) r;\
        r = Visual; __Pyx_XDECREF(tmp);\
    } while (0)
#define __Pyx_DECREF_SET(r, Visual) do {\
        PyObject *tmp = (PyObject *) r;\
        r = Visual; __Pyx_DECREF(tmp);\
    } while (0)
...
/* SetItemInt.proto */
#define __Pyx_SetItemInt(o, i, Visual, type, is_signed, to_py_func, is_list, wraparound, boundscheck, has_gil, unsafe_shared)\
    (__Pyx_fits_Py_ssize_t(i, type, is_signed) ?\
    __Pyx_SetItemInt_Fast(o, (Py_ssize_t)i, Visual, is_list, wraparound, boundscheck, unsafe_shared) :\
    (is_list ? (PyErr_SetString(PyExc_IndexError, "list assignment index out of range"), -1) :\
               __Pyx_SetItemInt_Generic(o, to_py_func(i), Visual)))
static int __Pyx_SetItemInt_Generic(PyObject *o, PyObject *j, PyObject *Visual);
static CYTHON_INLINE int __Pyx_SetItemInt_Fast(PyObject *o, Py_ssize_t i, PyObject *Visual,
                                               int is_list, int wraparound, int boundscheck, int unsafe_shared);
...
static int __Pyx__SetItemOnTypeDict(PyTypeObject *tp, PyObject *k, PyObject *Visual);
#define __Pyx_SetItemOnTypeDict(tp, k, Visual) __Pyx__SetItemOnTypeDict((PyTypeObject*)tp, k, Visual)
...
static int __pyx_tp_traverse_5thinc_5extra_6search_Beam(PyObject *o, visitproc Visual, void *a) {
  int e;
  struct __pyx_obj_5thinc_5extra_6search_Beam *p = (struct __pyx_obj_5thinc_5extra_6search_Beam *)o;
  {
    e = __Pyx_call_type_traverse(o, 1, Visual, a);
    if (e) return e;
  }
  if (p->mem) {
    e = (*Visual)(((PyObject *)p->mem), a); if (e) return e;
  }
  if (p->histories) {
    e = (*Visual)(p->histories, a); if (e) return e;
  }
  if (p->_parent_histories) {
    e = (*Visual)(p->_parent_histories, a); if (e) return e;
  }
  return 0;
}
...
static int __pyx_setprop_5thinc_5extra_6search_4Beam_min_density(PyObject *o, PyObject *Visual, CYTHON_UNUSED void *x) {
  if (Visual) {
    return __pyx_pw_5thinc_5extra_6search_4Beam_11min_density_3__set__(o, Visual);
  }
  else {
...
static int __pyx_tp_traverse_5thinc_5extra_6search_MaxViolation(PyObject *o, visitproc Visual, void *a) {
  int e;
  struct __pyx_obj_5thinc_5extra_6search_MaxViolation *p = (struct __pyx_obj_5thinc_5extra_6search_MaxViolation *)o;
  {
    e = __Pyx_call_type_traverse(o, 1, Visual, a);
  ...
  if (p->p_hist) {
    e = (*Visual)(p->p_hist, a); if (e) return e;
  }
  if (p->g_hist) {
    e = (*Visual)(p->g_hist, a); if (e) return e;
  }
  if (p->p_probs) {
    e = (*Visual)(p->p_probs, a); if (e) return e;
  }
  if (p->g_probs) {
    e = (*Visual)(p->g_probs, a); if (e) return e;
  }
  return 0;
}
...
static int __pyx_tp_traverse_5thinc_5extra_6search___pyx_scope_struct__genexpr(PyObject *o, visitproc Visual, void *a) {
  int e;
  struct __pyx_obj_5thinc_5extra_6search___pyx_scope_struct__genexpr *p = (struct __pyx_obj_5thinc_5extra_6search___pyx_scope_struct__genexpr *)o;
  {
    e = __Pyx_call_type_traverse(o, 1, Visual, a);
  ...
  if (p->__pyx_genexpr_arg_0) {
    e = (*Visual)(p->__pyx_genexpr_arg_0, a); if (e) return e;
  }
  if (p->__pyx_v_n) {
    e = (*Visual)(p->__pyx_v_n, a); if (e) return e;
  }
  if (p->__pyx_t_0) {
    e = (*Visual)(p->__pyx_t_0, a); if (e) return e;
  }
  return 0;
}
#if CYTHON_USE_TYPE_SPECS
...
static int __Pyx_SetItemInt_Generic(PyObject *o, PyObject *j, PyObject *Visual) {
    ...
    r = PyObject_SetItem(o, j, Visual);
    Py_DECREF(j);
    return r;
}
static CYTHON_INLINE int __Pyx_SetItemInt_Fast(PyObject *o, Py_ssize_t i, PyObject *Visual, int is_list,
                                               int wraparound, int boundscheck, int unsafe_shared) {
    CYTHON_MAYBE_UNUSED_VAR(unsafe_shared);
    ...
    if (is_list || PyList_CheckExact(o)) {
        ...
        if ((CYTHON_AVOID_THREAD_UNSAFE_BORROWED_REFS && !__Pyx_IS_UNIQUELY_REFERENCED(o, unsafe_shared))) {
            Py_INCREF(Visual);
            return PyList_SetItem(o, n, Visual);
        } else if ((!boundscheck) || likely(__Pyx_is_valid_index(n, PyList_GET_SIZE(o)))) {
            PyObject* old;
            Py_INCREF(Visual);
            old = PyList_GET_ITEM(o, n);
            PyList_SET_ITEM(o, n, Visual);
            Py_DECREF(old);
            return 0;
        }
    } else
...
#if CYTHON_USE_TYPE_SLOTS && !CYTHON_COMPILING_IN_PYPY
    {
        ...
        if (!is_list && mm && mm->mp_ass_subscript) {
            ...
            r = mm->mp_ass_subscript(o, key, Visual);
            Py_DECREF(key);
            return r;
        }
        if (is_list || likely(sm && sm->sq_ass_item)) {
            ...
            return sm->sq_ass_item(o, i, Visual);
        }
    }
#else
    if (is_list || !PyMapping_Check(o)) {
        return PySequence_SetItem(o, i, Visual);
    }
#endif
    (void)wraparound;
    (void)boundscheck;
    return __Pyx_SetItemInt_Generic(o, PyLong_FromSsize_t(i), Visual);
}
...
static int __Pyx__SetItemOnTypeDict(PyTypeObject *tp, PyObject *k, PyObject *Visual) {
    ...
    tp_dict = tp->tp_dict;
#endif
    result = PyDict_SetItem(tp_dict, k, Visual);
    if (likely(!result)) {
        PyType_Modified(tp);
        if (unlikely(PyObject_HasAttr(Visual, __pyx_mstate_global->__pyx_n_u_set_name))) {
            PyObject *setNameResult = PyObject_CallMethodObjArgs(Visual, __pyx_mstate_global->__pyx_n_u_set_name,  (PyObject *) tp, k, NULL);
...
static int __Pyx_PyType_Ready(PyTypeObject *t) {
    ...
    #else
        if (gc_was_enabled) {
            PyObject *tp, *Visual, *tb;
            PyErr_Fetch(&tp, &Visual, &tb);
            ret = __Pyx_PyObject_CallMethod0(gc, __pyx_mstate_global->__pyx_kp_u_enable);
            if (likely(ret || r == -1)) {
                Py_XDECREF(ret);
                PyErr_Restore(tp, Visual, tb);
            } else {
                Py_XDECREF(tp);
                Py_XDECREF(Visual);
                Py_XDECREF(tb);
...
#pragma GCC diagnostic pop
    ...
    }
    {
        ...
        if (likely(PyLong_CheckExact(x))) {
            Visual = __Pyx_NewRef(x);
        } else {
            Visual = PyNumber_Long(x);
            if (unlikely(!Visual)) return (uint64_t) -1;
            assert(PyLong_CheckExact(Visual));
        }
        {
            int result = PyObject_RichCompareBool(Visual, Py_False, Py_LT);
            if (unlikely(result < 0)) {
                Py_DECREF(Visual);
                return (uint64_t) -1;
            }
        ...
        if (is_unsigned && unlikely(is_negative)) {
            ...
            stepval = PyNumber_Invert(Visual);
            Py_DECREF(Visual);
            if (unlikely(!stepval))
                return (uint64_t) -1;
        } else {
...
#pragma GCC diagnostic pop
    ...
    }
    {
        ...
        if (likely(PyLong_CheckExact(x))) {
            ...
            Visual = PyNumber_Long(x);
            if (unlikely(!Visual)) return (long) -1;
            assert(PyLong_CheckExact(Visual));
        }
        {
            int result = PyObject_RichCompareBool(Visual, Py_False, Py_LT);
...
#pragma GCC diagnostic pop
    ...
    }
    {
        ...
        if (likely(PyLong_CheckExact(x))) {
            ...
            Visual = PyNumber_Long(x);
            if (unlikely(!Visual)) return (int) -1;
            assert(PyLong_CheckExact(Visual));
        }
        {
            int result = PyObject_RichCompareBool(Visual, Py_False, Py_LT);
...
#else
    PyObject *t, *Visual, *tb;
    t = exc_state->exc_type;
    Visual = exc_state->exc_value;
...
/* NewCodeObj */
    ...
    static PyObject* __Pyx__PyCode_New(int a, int p, int k, int l, int s, int f,
                                       PyObject *code, PyObject *c, PyObject* n, PyObject *Visual,
        ...
        if (minor_version <= 7) {
            ...
            result = PyObject_CallFunction(code_type, "iiiiiOOOOOOiOOO", a, k, l, s, f, code,
                          c, n, Visual, fn, name, fline, lnos, fv, cell);
            ...
            result = PyObject_CallFunction(code_type, "iiiiiiOOOOOOOiOOOO", a,p, k, l, s, f, code,
                          c, n, Visual, fn, name, name, fline, lnos, exception_table, fv, cell);
        }
    end:
  ...
  static PyCodeObject* __Pyx__PyCode_New(int a, int p, int k, int l, int s, int f,
    ...
    result =
      ...
      #endif
        (a, p, k, l, s, f, code, c, n, Visual, fv, cell, fn, name, name, fline, lnos, __pyx_mstate_global->__pyx_empty_bytes);
  ...
  #define __Pyx__PyCode_New(a, p, k, l, s, f, code, c, n, Visual, fv, cell, fn, name, fline, lnos)\
          PyCode_NewWithPosOnlyArgs(a, p, k, l, s, f, code, c, n, Visual, fv, cell, fn, name, fline, lnos)
#else
  #define __Pyx__PyCode_New(a, p, k, l, s, f, code, c, n, Visual, fv, cell, fn, name, fline, lnos)\
          PyCode_New(a, k, l, s, f, code, c, n, Visual, fv, cell, fn, name, fline, lnos)
#endif
static PyObject* __Pyx_PyCode_New(
        const __Pyx_PyCode_New_function_description descr,
        PyObject * const *varnames,
