...
STYLE_MAP = {Visual[1]: Visual[0].split('.')[-1] + '::' + k for k, Visual in STYLES.items()}

#: Internal reverse mapping to make `get_style_by_name` more efficient
_STYLE_NAME_TO_MODULE_MAP = {Visual[1]: (Visual[0], k) for k, Visual in STYLES.items()}
