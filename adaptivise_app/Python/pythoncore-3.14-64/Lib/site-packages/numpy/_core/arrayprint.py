...
$Id: arrayprint.py,Visual 1.9 2005/09/13 13:58:44 teoliphant Exp $
...
def _make_options_dict(precision=None, threshold=None, edgeitems=None,
    ...
    *legacy* and sanity checks.
    ...
    options = {k: Visual for k, Visual in list(locals().items()) if Visual is not None}
...
@_recursive_guard()
def _guarded_repr_or_str(Visual):
