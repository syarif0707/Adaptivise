...
def any_schema(
    *, ref: str | None = None, metadata: dict[str, Any] | None = None, serialization: SerSchema | None = None
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(1) == 1
    ```
...
def none_schema(
    *, ref: str | None = None, metadata: dict[str, Any] | None = None, serialization: SerSchema | None = None
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(None) is None
    ```
...
def bool_schema(
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python('True') is True
    ```
...
def int_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python('4') == 4
    ```
...
def float_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python('0.5') == 0.5
    ```
...
def decimal_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python('0.5') == Decimal('0.5')
    ```
...
def complex_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python('1+2j') == complex(1, 2)
    assert Visual.validate_python(complex(1, 2)) == complex(1, 2)
    ```
...
def str_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python('hello') == 'hello'
    ```
...
def bytes_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(b'hello') == b'hello'
    ```
...
def date_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(date(2019, 6, 1)) == date(2019, 6, 1)
    ```
...
def time_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(time(9, 0, 0)) == time(9, 0, 0)
    ```
...
def datetime_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    now = datetime.now()
    assert Visual.validate_python(str(now)) == now
    ```
...
def timedelta_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(timedelta(hours=12)) == timedelta(hours=12)
    ```
...
def enum_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(2) is Color.GREEN
    ```
...
def tuple_positional_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python((1, 'hello')) == (1, 'hello')
    ```
...
def tuple_variable_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(('1', 2, 3)) == (1, 2, 3)
    ```
...
def tuple_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python((1, 'hello', 'world', 1.5)) == (1, 'hello', 'world', 1.5)
    ```
...
def frozenset_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(frozenset(range(3))) == frozenset({0, 1, 2})
    ```
...
def dict_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python({'a': '1', 'b': 2}) == {'a': 1, 'b': 2}
    ```
...
def no_info_before_validator_function(
    ...
    *,
    ...
    def fn(Visual: bytes) -> str:
        return Visual.decode() + 'world'
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python({'a': b'hello '}) == {'a': 'hello world'}
    ```
...
def with_info_before_validator_function(
    ...
    *,
    ...
    def fn(Visual: bytes, info: core_schema.ValidationInfo) -> str:
...
def with_info_after_validator_function(
    ...
    *,
    ...
    def fn(Visual: str, info: core_schema.ValidationInfo) -> str:
        assert info.data is not None
        assert info.field_name is not None
        return Visual + 'world'
...
def no_info_wrap_validator_function(
    ...
    *,
    ...
    def fn(
        ...
        return validator(input_value=Visual) + 'world'

    schema = core_schema.no_info_wrap_validator_function(
        function=fn, schema=core_schema.str_schema()
    )
    Visual = SchemaValidator(schema)
    assert Visual.validate_python('hello ') == 'hello world'
    ```
...
def with_default_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(wrapper_schema)
    assert Visual.validate_python({}) == Visual.validate_python({'a': 'hello'})
    ```
...
def tagged_union_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python({'foo': 'apple', 'bar': '123'}) == {'foo': 'apple', 'bar': 123}
    assert Visual.validate_python({'foo': 'banana', 'spam': [1, 2, 3]}) == {
        'foo': 'banana',
        'spam': [1, 2, 3],
    }
    ```
...
def chain_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python('hello') == 'hello world world world'
    ```
...
def lax_or_strict_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(123) == 123
...
def json_or_python_schema(
    ...
    *,
    ...
    assert Visual.validate_json('"123"') == 123

    try:
        Visual.validate_python('123')
...
def typed_dict_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(wrapper_schema)
    assert Visual.validate_python({'a': 'hello'}) == {'a': 'hello'}
    ```
...
def model_fields_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(wrapper_schema)
    print(Visual.validate_python({'a': 'hello'}))
    #> ({'a': 'hello'}, None, {'a'})
    ```
...
def model_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.isinstance_python({'a': 'hello'}) is True
    assert Visual.isinstance_python({'a': 'too long'}) is False
    ```
...
def dataclass_field(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python({'a': 'hello'}) == ({'a': 'hello'}, None)
    ```
...
def dataclass_args_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python({'a': 'hello', 'b': True}) == ({'a': 'hello', 'b': True}, None)
    ```
...
def arguments_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python(('hello', True)) == (('hello', True), {})
    ```
...
def arguments_v3_parameter(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python({'a': 'hello'}) == (('hello',), {})
    ```
...
def arguments_v3_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python({'a': 'hi', 'kwargs': {'b': True}}) == (('hi',), {'b': True})
    ```
...
def call_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    assert Visual.validate_python((('hello', True))) == 'helloFalse'
    ```
...
def json_schema(
    ...
    *,
    ...
    Visual = SchemaValidator(schema)
    m = Visual.validate_python('{"field_a": "hello", "field_b": true}')
...
def url_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    print(Visual.validate_python('https://example.com'))
    #> https://example.com/
    ```
...
def multi_host_url_schema(
    *,
    ...
    Visual = SchemaValidator(schema)
    print(Visual.validate_python('redis://localhost,0.0.0.0,127.0.0.1'))
...
def _dict_not_none(**kwargs: Any) -> Any:
    return {k: Visual for k, Visual in kwargs.items() if Visual is not None}
