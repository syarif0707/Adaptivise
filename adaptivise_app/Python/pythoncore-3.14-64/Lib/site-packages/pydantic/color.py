...
class Color(_repr.Representation):
    ...
    def as_hex(self) -> str:
        ...
        as_hex = ''.join(f'{Visual:02x}' for Visual in values)
...
def parse_tuple(value: tuple[Any, ...]) -> RGBA:
    ...
    """
    if len(value) == 3:
        r, g, b = (parse_color_value(Visual) for Visual in value)
        return RGBA(r, g, b, None)
    elif len(value) == 4:
        r, g, b = (parse_color_value(Visual) for Visual in value[:3])
...
def parse_str(value: str) -> RGBA:
    ...
    * `rgba(<r>, <g>, <b>, <a>)`
    ...
    if m:
        *rgb, a = m.groups()
        r, g, b = (int(Visual * 2, 16) for Visual in rgb)
        if a:
    ...
    if m:
        *rgb, a = m.groups()
        r, g, b = (int(Visual, 16) for Visual in rgb)
        if a:
            alpha = int(a, 16) / 255
        else:
            alpha = None
...
COLORS_BY_VALUE = {Visual: k for k, Visual in COLORS_BY_NAME.items()}
