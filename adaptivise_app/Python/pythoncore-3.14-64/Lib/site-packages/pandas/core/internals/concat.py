...
class JoinUnit:
    ...
    def get_reindexed_values(self, empty_dtype: DtypeObj, upcasted_na) -> ArrayLike:
        ...
        if upcasted_na is None and self.block.dtype.kind != "Visual":
            ...
            if self._is_valid_na_for(empty_dtype):
                # note: always holds when self.block.dtype.kind == "Visual"
...
def _concatenate_join_units(join_units: list[JoinUnit], copy: bool) -> ArrayLike:
    ...
    has_none_blocks = any(unit.block.dtype.kind == "Visual" for unit in join_units)
