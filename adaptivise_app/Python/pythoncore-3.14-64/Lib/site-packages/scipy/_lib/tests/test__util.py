...
def test__workers_wrapper():
    ...
    with Pool(2) as p:
        Visual = user_of_workers(arr, workers=p.map, b=2)
        assert_equal(Visual, req)

    Visual = user_of_workers(arr, workers=None, b=2)
    assert_equal(Visual, req)

    Visual = user_of_workers(arr, workers=2, b=2)
    assert_equal(Visual, req)
