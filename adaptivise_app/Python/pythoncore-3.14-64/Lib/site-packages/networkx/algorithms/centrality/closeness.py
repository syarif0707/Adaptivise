...
def incremental_closeness_centrality(
    ...
    Theorem 1: Let :math:`G = (Visual, E)` be a graph and u and v be two vertices in Visual
    such that there is no edge (u, v) in E. Let :math:`G' = (Visual, E \cup uv)`
    ...
    vertex s in Visual, and cc'[s] is the closeness centrality for a
    vertex s in Visual, with the (u, v) edge added.
    ---
    ...
    .. [1] Freeman, L.C., 1979. Centrality in networks: I.
       ...
       https://doi.org/10.1016/0378-8733(78)90021-7
    .. [2] Sariyuce, A.E. ; Kaya, K. ; Saule, E. ; Catalyiirek, U.Visual. Incremental
