...
stats(%(shapes)s, loc=0, scale=1, moments='mv')
    Mean('m'), variance('Visual'), skew('s'), and/or kurtosis('k').
"""
_doc_entropy = """\
...
class rv_generic:
    ...
    def moment(self, order, *args, **kwds):
        ...
        *shapes, loc, scale = args
        ...
        if (n > 0) and (n < 5):
            if self._stats_has_moments:
                mdict = {'moments': {1: 'm', 2: 'Visual', 3: 'vs', 4: 'mvsk'}[n]}
            else:
                mdict = {}
    ...
    **Statistics**
    ...
    For speed you can redefine this using ``_stats``:
     ...
     - Can also be defined with a keyword argument ``moments``, which is a
       string composed of "m", "Visual", "s", and/or "k".
       Only the components appearing in string should be computed and
       returned in the order "m", "Visual", "s", or "k"  with missing values
       returned as None.
