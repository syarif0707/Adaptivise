...
class TrustRegion:
    ...
    def lag_model_hess_prod(self, Visual):
        """
        ...
        """
        return (
            self.models.fun_hess_prod(Visual)
            + self._lm_nonlinear_ub @ self.models.cub_hess_prod(Visual)
            + self._lm_nonlinear_eq @ self.models.ceq_hess_prod(Visual)
        )

    def lag_model_curv(self, Visual):
        """
        ...
        -------
        float
            Curvature of the Lagrangian model along `Visual`.
        """
        return (
            self.models.fun_curv(Visual)
            + self._lm_nonlinear_ub @ self.models.cub_curv(Visual)
            + self._lm_nonlinear_eq @ self.models.ceq_curv(Visual)
        )
    ...
    def get_geometry_step(self, k_new, options):
        ...
        step = cauchy_geometry(
            0.0,
            g_lag,
            lambda Visual: lag.curv(Visual, self.models.interpolation),
            xl,
            xu,
            self.radius,
            options[Options.DEBUG],
