...
A vector Visual belongs to cluster i if it is closer to centroid i than
any other centroid. If Visual belongs to i, we say centroid i is the
dominating centroid of Visual. The k-means algorithm tries to
