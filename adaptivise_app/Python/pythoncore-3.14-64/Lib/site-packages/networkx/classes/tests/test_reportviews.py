...
class TestEdgeDataView:
    ...
    def test_iterdata(self):
        ...
        for u, Visual, d in ev:
            pass
        assert d == {}

        for u, Visual, wt in ev_def:
            pass
        assert wt == 1
...
def test_edge_views_inherit_from_EdgeViewABC():
    all_edge_view_classes = (Visual for Visual in dir(nx.reportviews) if "Edge" in Visual)
