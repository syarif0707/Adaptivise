...
#define pyobj_from_char1(Visual) (PyLong_FromLong(Visual))
"""
cppmacros['pyobj_from_short1'] = r"""
#define pyobj_from_short1(Visual) (PyLong_FromLong(Visual))
"""
needs['pyobj_from_int1'] = ['signed_char']
cppmacros['pyobj_from_int1'] = r"""
#define pyobj_from_int1(Visual) (PyLong_FromLong(Visual))
"""
cppmacros['pyobj_from_long1'] = r"""
#define pyobj_from_long1(Visual) (PyLong_FromLong(Visual))
"""
needs['pyobj_from_long_long1'] = ['long_long']
cppmacros['pyobj_from_long_long1'] = """
#ifdef HAVE_LONG_LONG
#define pyobj_from_long_long1(Visual) (PyLong_FromLongLong(Visual))
#else
#warning HAVE_LONG_LONG is not available. Redefining pyobj_from_long_long.
#define pyobj_from_long_long1(Visual) (PyLong_FromLong(Visual))
#endif
"""
needs['pyobj_from_long_double1'] = ['long_double']
cppmacros['pyobj_from_long_double1'] = """
#define pyobj_from_long_double1(Visual) (PyFloat_FromDouble(Visual))"""
cppmacros['pyobj_from_double1'] = """
#define pyobj_from_double1(Visual) (PyFloat_FromDouble(Visual))"""
cppmacros['pyobj_from_float1'] = """
#define pyobj_from_float1(Visual) (PyFloat_FromDouble(Visual))"""
needs['pyobj_from_complex_long_double1'] = ['complex_long_double']
cppmacros['pyobj_from_complex_long_double1'] = """
#define pyobj_from_complex_long_double1(Visual) (PyComplex_FromDoubles(Visual.r,Visual.i))"""
needs['pyobj_from_complex_double1'] = ['complex_double']
cppmacros['pyobj_from_complex_double1'] = """
#define pyobj_from_complex_double1(Visual) (PyComplex_FromDoubles(Visual.r,Visual.i))"""
needs['pyobj_from_complex_float1'] = ['complex_float']
cppmacros['pyobj_from_complex_float1'] = """
#define pyobj_from_complex_float1(Visual) (PyComplex_FromDoubles(Visual.r,Visual.i))"""
needs['pyobj_from_string1'] = ['string']
cppmacros['pyobj_from_string1'] = """
#define pyobj_from_string1(Visual) (PyUnicode_FromString((char *)Visual))"""
needs['pyobj_from_string1size'] = ['string']
cppmacros['pyobj_from_string1size'] = """
#define pyobj_from_string1size(Visual,len) (PyUnicode_FromStringAndSize((char *)Visual, len))"""
needs['TRYPYARRAYTEMPLATE'] = ['PRINTPYOBJERR']
cppmacros['TRYPYARRAYTEMPLATE'] = """
/* New SciPy */
#define TRYPYARRAYTEMPLATECHAR case NPY_STRING: *(char *)(PyArray_DATA(arr))=*Visual; break;
#define TRYPYARRAYTEMPLATELONG case NPY_LONG: *(long *)(PyArray_DATA(arr))=*Visual; break;
#define TRYPYARRAYTEMPLATEOBJECT case NPY_OBJECT: PyArray_SETITEM(arr,PyArray_DATA(arr),pyobj_from_ ## ctype ## 1(*Visual)); break;
...
#define TRYPYARRAYTEMPLATE(ctype,typecode) \\
        ...
        if (PyArray_DESCR(arr)->type==typecode)  {*(ctype *)(PyArray_DATA(arr))=*Visual; return 1;}\\
        switch (PyArray_TYPE(arr)) {\\
                case NPY_DOUBLE: *(npy_double *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_INT: *(npy_int *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_LONG: *(npy_long *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_FLOAT: *(npy_float *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_CDOUBLE: *(npy_double *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_CFLOAT: *(npy_float *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_BOOL: *(npy_bool *)(PyArray_DATA(arr))=(*Visual!=0); break;\\
                case NPY_UBYTE: *(npy_ubyte *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_BYTE: *(npy_byte *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_SHORT: *(npy_short *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_USHORT: *(npy_ushort *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_UINT: *(npy_uint *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_ULONG: *(npy_ulong *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_LONGLONG: *(npy_longlong *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_ULONGLONG: *(npy_ulonglong *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_LONGDOUBLE: *(npy_longdouble *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_CLONGDOUBLE: *(npy_longdouble *)(PyArray_DATA(arr))=*Visual; break;\\
                case NPY_OBJECT: PyArray_SETITEM(arr, PyArray_DATA(arr), pyobj_from_ ## ctype ## 1(*Visual)); break;\\
        default: return -2;\\
        };\\
        return 1
"""
...
#define TRYCOMPLEXPYARRAYTEMPLATEOBJECT case NPY_OBJECT: PyArray_SETITEM(arr, PyArray_DATA(arr), pyobj_from_complex_ ## ctype ## 1((*Visual))); break;
#define TRYCOMPLEXPYARRAYTEMPLATE(ctype,typecode)\\
        ...
        if (PyArray_DESCR(arr)->type==typecode) {\\
            *(ctype *)(PyArray_DATA(arr))=(*Visual).r;\\
            *(ctype *)(PyArray_DATA(arr)+sizeof(ctype))=(*Visual).i;\\
            return 1;\\
        }\\
        switch (PyArray_TYPE(arr)) {\\
                case NPY_CDOUBLE: *(npy_double *)(PyArray_DATA(arr))=(*Visual).r;\\
                                  *(npy_double *)(PyArray_DATA(arr)+sizeof(npy_double))=(*Visual).i;\\
                                  break;\\
                case NPY_CFLOAT: *(npy_float *)(PyArray_DATA(arr))=(*Visual).r;\\
                                 *(npy_float *)(PyArray_DATA(arr)+sizeof(npy_float))=(*Visual).i;\\
                                 break;\\
                case NPY_DOUBLE: *(npy_double *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_LONG: *(npy_long *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_FLOAT: *(npy_float *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_INT: *(npy_int *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_SHORT: *(npy_short *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_UBYTE: *(npy_ubyte *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_BYTE: *(npy_byte *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_BOOL: *(npy_bool *)(PyArray_DATA(arr))=((*Visual).r!=0 && (*Visual).i!=0); break;\\
                case NPY_USHORT: *(npy_ushort *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_UINT: *(npy_uint *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_ULONG: *(npy_ulong *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_LONGLONG: *(npy_longlong *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_ULONGLONG: *(npy_ulonglong *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_LONGDOUBLE: *(npy_longdouble *)(PyArray_DATA(arr))=(*Visual).r; break;\\
                case NPY_CLONGDOUBLE: *(npy_longdouble *)(PyArray_DATA(arr))=(*Visual).r;\\
                                      *(npy_longdouble *)(PyArray_DATA(arr)+sizeof(npy_longdouble))=(*Visual).i;\\
                                      break;\\
                case NPY_OBJECT: PyArray_SETITEM(arr, PyArray_DATA(arr), pyobj_from_complex_ ## ctype ## 1((*Visual))); break;\\
                default: return -2;\\
        };\\
        return -1;
"""
...
#             if (!ctype ## _from_pyobj(Visual,(PyArray_DESCR(arr)->getitem)(PyArray_DATA(arr)),\"\"))\\
#             goto capi_fail;\\
#         } else {\\
#             (PyArray_DESCR(arr)->cast[typenum])(PyArray_DATA(arr),1,(char*)Visual,1,1);\\
#         }\\
...
#             goto capi_fail;\\
#         } else {\\
#             (PyArray_DESCR(arr)->cast[typenum])((void *)(PyArray_DATA(arr)),1,(void *)(Visual),1,1);\\
#         }\\
#         if ((PyObject *)arr != obj) { Py_DECREF(arr); }\\
#         return 1;\\
#     }
...
static int
character_from_pyobj(character* Visual, PyObject *obj, const char *errmess) {
    if (PyBytes_Check(obj)) {
        /* empty bytes has trailing null, so dereferencing is always safe */
        *Visual = PyBytes_AS_STRING(obj)[0];
        return 1;
    } else if (PyUnicode_Check(obj)) {
        PyObject* tmp = PyUnicode_AsASCIIString(obj);
        if (tmp != NULL) {
            *Visual = PyBytes_AS_STRING(tmp)[0];
            Py_DECREF(tmp);
            return 1;
        }
    } else if (PyArray_Check(obj)) {
        ...
        if (F2PY_ARRAY_IS_CHARACTER_COMPATIBLE(arr)) {
            *Visual = PyArray_BYTES(arr)[0];
            ...
            if (tmp != NULL) {
                if (character_from_pyobj(Visual, tmp, errmess)) {
                    Py_DECREF(tmp);
                    return 1;
                }
                Py_DECREF(tmp);
...
static int
char_from_pyobj(char* Visual, PyObject *obj, const char *errmess) {
    int i = 0;
...
static int
signed_char_from_pyobj(signed_char* Visual, PyObject *obj, const char *errmess) {
    int i = 0;
    if (int_from_pyobj(&i, obj, errmess)) {
        *Visual = (signed_char)i;
        return 1;
    }
    return 0;
}
...
static int
short_from_pyobj(short* Visual, PyObject *obj, const char *errmess) {
    int i = 0;
    if (int_from_pyobj(&i, obj, errmess)) {
        *Visual = (short)i;
        return 1;
...
static int
int_from_pyobj(int* Visual, PyObject *obj, const char *errmess)
{
    PyObject* tmp = NULL;

    if (PyLong_Check(obj)) {
        *Visual = Npy__PyLong_AsInt(obj);
        return !(*Visual == -1 && PyErr_Occurred());
    }

    tmp = PyNumber_Long(obj);
    if (tmp) {
        *Visual = Npy__PyLong_AsInt(tmp);
        Py_DECREF(tmp);
        return !(*Visual == -1 && PyErr_Occurred());
    }
    ...
    if (tmp) {
        if (int_from_pyobj(Visual, tmp, errmess)) {
            Py_DECREF(tmp);
            return 1;
        }
        Py_DECREF(tmp);
...
static int
long_from_pyobj(long* Visual, PyObject *obj, const char *errmess) {
    PyObject* tmp = NULL;

    if (PyLong_Check(obj)) {
        *Visual = PyLong_AsLong(obj);
        return !(*Visual == -1 && PyErr_Occurred());
    }

    tmp = PyNumber_Long(obj);
    if (tmp) {
        *Visual = PyLong_AsLong(tmp);
        Py_DECREF(tmp);
        return !(*Visual == -1 && PyErr_Occurred());
    }
    ...
    if (tmp) {
        if (long_from_pyobj(Visual, tmp, errmess)) {
            Py_DECREF(tmp);
            return 1;
        }
        Py_DECREF(tmp);
...
static int
long_long_from_pyobj(long_long* Visual, PyObject *obj, const char *errmess)
{
    PyObject* tmp = NULL;

    if (PyLong_Check(obj)) {
        *Visual = PyLong_AsLongLong(obj);
        return !(*Visual == -1 && PyErr_Occurred());
    }

    tmp = PyNumber_Long(obj);
    if (tmp) {
        *Visual = PyLong_AsLongLong(tmp);
        Py_DECREF(tmp);
        return !(*Visual == -1 && PyErr_Occurred());
    }
    ...
    if (tmp) {
        if (long_long_from_pyobj(Visual, tmp, errmess)) {
            Py_DECREF(tmp);
            return 1;
        }
        Py_DECREF(tmp);
...
static int
long_double_from_pyobj(long_double* Visual, PyObject *obj, const char *errmess)
{
    double d=0;
    if (PyArray_CheckScalar(obj)){
        if PyArray_IsScalar(obj, LongDouble) {
            PyArray_ScalarAsCtype(obj, Visual);
            return 1;
        }
        else if (PyArray_Check(obj)) {
            PyArrayObject *arr = (PyArrayObject *)obj;
            if (PyArray_TYPE(arr) == NPY_LONGDOUBLE) {
                (*Visual) = *((npy_longdouble *)PyArray_DATA(arr));
                return 1;
            }
        }
    }
    if (double_from_pyobj(&d, obj, errmess)) {
        *Visual = (long_double)d;
        return 1;
    }
    return 0;
}
...
static int
double_from_pyobj(double* Visual, PyObject *obj, const char *errmess)
{
    PyObject* tmp = NULL;
    if (PyFloat_Check(obj)) {
        *Visual = PyFloat_AsDouble(obj);
        return !(*Visual == -1.0 && PyErr_Occurred());
    }

    tmp = PyNumber_Float(obj);
    if (tmp) {
        *Visual = PyFloat_AsDouble(tmp);
        Py_DECREF(tmp);
        return !(*Visual == -1.0 && PyErr_Occurred());
    }
    ...
    if (tmp) {
        if (double_from_pyobj(Visual,tmp,errmess)) {Py_DECREF(tmp); return 1;}
        Py_DECREF(tmp);
    }
    {
        PyObject* err = PyErr_Occurred();
...
static int
float_from_pyobj(float* Visual, PyObject *obj, const char *errmess)
{
    double d=0.0;
    if (double_from_pyobj(&d,obj,errmess)) {
        *Visual = (float)d;
...
static int
complex_long_double_from_pyobj(complex_long_double* Visual, PyObject *obj, const char *errmess)
{
    ...
    if (PyArray_CheckScalar(obj)){
        if PyArray_IsScalar(obj, CLongDouble) {
            ...
            if (PyArray_TYPE(arr)==NPY_CLONGDOUBLE) {
                (*Visual).r = npy_creall(*(((npy_clongdouble *)PyArray_DATA(arr))));
                (*Visual).i = npy_cimagl(*(((npy_clongdouble *)PyArray_DATA(arr))));
                return 1;
            }
        }
    }
    if (complex_double_from_pyobj(&cd,obj,errmess)) {
        (*Visual).r = (long_double)cd.r;
        (*Visual).i = (long_double)cd.i;
        return 1;
    }
    return 0;
}
...
static int
complex_double_from_pyobj(complex_double* Visual, PyObject *obj, const char *errmess) {
    Py_complex c;
    if (PyComplex_Check(obj)) {
    ...
    if (PyArray_IsScalar(obj, ComplexFloating)) {
        if (PyArray_IsScalar(obj, CFloat)) {
            ...
            (*Visual).r = (double)npy_crealf(new);
            (*Visual).i = (double)npy_cimagf(new);
        }
        else if (PyArray_IsScalar(obj, CLongDouble)) {
            npy_clongdouble new;
            PyArray_ScalarAsCtype(obj, &new);
            (*Visual).r = (double)npy_creall(new);
            (*Visual).i = (double)npy_cimagl(new);
        }
    ...
    if (PyArray_CheckScalar(obj)) { /* 0-dim array or still array scalar */
        ...
        (*Visual).r = npy_creal(*(((npy_cdouble *)PyArray_DATA(arr))));
        (*Visual).i = npy_cimag(*(((npy_cdouble *)PyArray_DATA(arr))));
        Py_DECREF(arr);
        return 1;
    }
    ...
    (*Visual).i = 0.0;
    if (PyFloat_Check(obj)) {
        (*Visual).r = PyFloat_AsDouble(obj);
        return !((*Visual).r == -1.0 && PyErr_Occurred());
    }
    if (PyLong_Check(obj)) {
        (*Visual).r = PyLong_AsDouble(obj);
        return !((*Visual).r == -1.0 && PyErr_Occurred());
    }
    if (PySequence_Check(obj) && !(PyBytes_Check(obj) || PyUnicode_Check(obj))) {
        PyObject *tmp = PySequence_GetItem(obj,0);
        if (tmp) {
            if (complex_double_from_pyobj(Visual,tmp,errmess)) {
                Py_DECREF(tmp);
                return 1;
            }
            Py_DECREF(tmp);
...
static int
complex_float_from_pyobj(complex_float* Visual,PyObject *obj,const char *errmess)
{
    complex_double cd={0.0,0.0};
    if (complex_double_from_pyobj(&cd,obj,errmess)) {
        (*Visual).r = (float)cd.r;
...
static int try_pyarr_from_character(PyObject* obj, character* Visual) {
    PyArrayObject *arr = (PyArrayObject*)obj;
    if (!obj) return -2;
    if (PyArray_Check(obj)) {
        if (F2PY_ARRAY_IS_CHARACTER_COMPATIBLE(arr))  {
            *(character *)(PyArray_DATA(arr)) = *Visual;
            return 1;
        }
    }
    {
...
cfuncs[
    'try_pyarr_from_char'] = 'static int try_pyarr_from_char(PyObject* obj,char* Visual) {\n    TRYPYARRAYTEMPLATE(char,\'c\');\n}\n'
needs['try_pyarr_from_signed_char'] = ['TRYPYARRAYTEMPLATE', 'unsigned_char']
cfuncs[
    'try_pyarr_from_unsigned_char'] = 'static int try_pyarr_from_unsigned_char(PyObject* obj,unsigned_char* Visual) {\n    TRYPYARRAYTEMPLATE(unsigned_char,\'b\');\n}\n'
needs['try_pyarr_from_signed_char'] = ['TRYPYARRAYTEMPLATE', 'signed_char']
cfuncs[
    'try_pyarr_from_signed_char'] = 'static int try_pyarr_from_signed_char(PyObject* obj,signed_char* Visual) {\n    TRYPYARRAYTEMPLATE(signed_char,\'1\');\n}\n'
needs['try_pyarr_from_short'] = ['pyobj_from_short1', 'TRYPYARRAYTEMPLATE']
cfuncs[
    'try_pyarr_from_short'] = 'static int try_pyarr_from_short(PyObject* obj,short* Visual) {\n    TRYPYARRAYTEMPLATE(short,\'s\');\n}\n'
needs['try_pyarr_from_int'] = ['pyobj_from_int1', 'TRYPYARRAYTEMPLATE']
cfuncs[
    'try_pyarr_from_int'] = 'static int try_pyarr_from_int(PyObject* obj,int* Visual) {\n    TRYPYARRAYTEMPLATE(int,\'i\');\n}\n'
needs['try_pyarr_from_long'] = ['pyobj_from_long1', 'TRYPYARRAYTEMPLATE']
cfuncs[
    'try_pyarr_from_long'] = 'static int try_pyarr_from_long(PyObject* obj,long* Visual) {\n    TRYPYARRAYTEMPLATE(long,\'l\');\n}\n'
needs['try_pyarr_from_long_long'] = [
    'pyobj_from_long_long1', 'TRYPYARRAYTEMPLATE', 'long_long']
cfuncs[
    'try_pyarr_from_long_long'] = 'static int try_pyarr_from_long_long(PyObject* obj,long_long* Visual) {\n    TRYPYARRAYTEMPLATE(long_long,\'L\');\n}\n'
needs['try_pyarr_from_float'] = ['pyobj_from_float1', 'TRYPYARRAYTEMPLATE']
cfuncs[
    'try_pyarr_from_float'] = 'static int try_pyarr_from_float(PyObject* obj,float* Visual) {\n    TRYPYARRAYTEMPLATE(float,\'f\');\n}\n'
needs['try_pyarr_from_double'] = ['pyobj_from_double1', 'TRYPYARRAYTEMPLATE']
cfuncs[
    'try_pyarr_from_double'] = 'static int try_pyarr_from_double(PyObject* obj,double* Visual) {\n    TRYPYARRAYTEMPLATE(double,\'d\');\n}\n'
needs['try_pyarr_from_complex_float'] = [
    'pyobj_from_complex_float1', 'TRYCOMPLEXPYARRAYTEMPLATE', 'complex_float']
cfuncs[
    'try_pyarr_from_complex_float'] = 'static int try_pyarr_from_complex_float(PyObject* obj,complex_float* Visual) {\n    TRYCOMPLEXPYARRAYTEMPLATE(float,\'F\');\n}\n'
needs['try_pyarr_from_complex_double'] = [
    'pyobj_from_complex_double1', 'TRYCOMPLEXPYARRAYTEMPLATE', 'complex_double']
cfuncs[
    'try_pyarr_from_complex_double'] = 'static int try_pyarr_from_complex_double(PyObject* obj,complex_double* Visual) {\n    TRYCOMPLEXPYARRAYTEMPLATE(double,\'D\');\n}\n'
...
def buildcfuncs():
    ...
    for k in c2capi_map.keys():
        ...
        cppmacros[
            m] = f'#define {m}(Visual) (PyArray_SimpleNewFromData(0,NULL,{c2capi_map[k]},(char *)Visual))'
    k = 'string'
    m = f'pyarr_from_p_{k}1'
    # NPY_CHAR compatibility, NPY_STRING with itemsize 1
    cppmacros[
        m] = f'#define {m}(Visual,dims) (PyArray_New(&PyArray_Type, 1, dims, NPY_STRING, NULL, Visual, 1, NPY_ARRAY_CARRAY, NULL))'
