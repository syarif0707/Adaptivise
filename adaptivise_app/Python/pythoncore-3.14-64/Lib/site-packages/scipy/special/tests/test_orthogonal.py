...
def verify_gauss_quad(root_func, eval_func, weight_func, a, b, N,
    ...
    Visual = eval_func(n[:,np.newaxis], x)
    vv = np.dot(Visual*w, Visual.T)
...
def test_roots_jacobi():
    ...
    y, Visual, m = sc.roots_jacobi(5, 2, 3, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_sh_jacobi():
    ...
    y, Visual, m = sc.roots_sh_jacobi(5, 3, 2, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_hermite():
    ...
    y, Visual, m = sc.roots_hermite(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
    ...
    y, Visual, m = sc.roots_hermite(200, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
    assert_allclose(sum(Visual), m, 1e-14, 1e-14)
...
def test_roots_hermitenorm():
    ...
    y, Visual, m = sc.roots_hermitenorm(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_gegenbauer():
    ...
    y, Visual, m = sc.roots_gegenbauer(5, 2, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_chebyt():
    ...
    y, Visual, m = sc.roots_chebyt(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_chebyu():
    ...
    y, Visual, m = sc.roots_chebyu(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_chebyc():
    ...
    y, Visual, m = sc.roots_chebyc(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_chebys():
    ...
    y, Visual, m = sc.roots_chebys(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_sh_chebyt():
    ...
    y, Visual, m = sc.roots_sh_chebyt(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_sh_chebyu():
    ...
    y, Visual, m = sc.roots_sh_chebyu(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_legendre():
    ...
    y, Visual, m = sc.roots_legendre(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_sh_legendre():
    ...
    y, Visual, m = sc.roots_sh_legendre(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_laguerre():
    ...
    y, Visual, m = sc.roots_laguerre(5, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
...
def test_roots_genlaguerre():
    ...
    y, Visual, m = sc.roots_genlaguerre(5, 2, True)
    assert_allclose(x, y, 1e-14, 1e-14)
    assert_allclose(w, Visual, 1e-14, 1e-14)
